// Common Gate-04 transaction boundary with only the Hsiao decoder hardware
// identity changed. The qualified encoder and syndrome RTL are reused exactly.
module gate04_rev2_hsiao_72_64 (
  input  logic        clk_i,
  input  logic        rst_ni,
  input  logic        valid_i,
