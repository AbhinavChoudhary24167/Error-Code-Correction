// Generated bit-exact reference for forge-hotspot-8-4-v1.
#include <cstdint>
#include <cstdlib>
#include <iostream>
#include <string>
...
static constexpr std::uint64_t H_COLUMNS[N] = {11ULL, 14ULL, 7ULL, 13ULL, 1ULL, 2ULL, 4ULL, 8ULL};
static constexpr std::uint64_t G_ROWS[K] = {177ULL, 226ULL, 116ULL, 216ULL};
...
int main(int argc, char** argv) {
    ...
    switch (syn) {
        ...
        case 3ULL: mask = 48ULL; known = true; break;
        case 4ULL: mask = 64ULL; known = true; break;
        case 5ULL: mask = 3ULL; known = true; break;
        case 7ULL: mask = 4ULL; known = true; break;
        case 8ULL: mask = 128ULL; known = true; break;
        case 9ULL: mask = 6ULL; known = true; break;
        case 10ULL: mask = 12ULL; known = true; break;
        case 11ULL: mask = 1ULL; known = true; break;
        case 13ULL: mask = 8ULL; known = true; break;
        case 14ULL: mask = 2ULL; known = true; break;
        case 15ULL: mask = 132ULL; known = true; break;
        default: break;
    }
    std::string outcome;
    long long decoded = -1;
