export DESIGN_NAME = secdaec_matched_sram_top
include /repo/campaigns/iscas_sustainability_extension/green_v3_2_matched_openram_orfs_validation/orfs/common.mk

export VERILOG_INCLUDE_DIRS = /repo/asic/include
export VERILOG_FILES = \
  /repo/asic/include/ecc_pkg.sv \
  /repo/asic/rtl/secded/secded_codec.sv \
  /repo/asic/rtl/secdaec/secdaec_codec.sv \
