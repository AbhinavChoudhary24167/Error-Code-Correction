# Corrected low/high sensitivity diagnostic.  The v1 evidence is retained;
# this version avoids querying a synthetic BTerm with the pin-only property API.
set out /repo/campaigns/iscas_sustainability_extension/green_v3_3_activity_complete_e5/diagnostics/bterm_activity_sensitivity_v2
file mkdir $out
...
puts "GREEN_V33_BTERM_ADAPTER_V2 source=[$iterm getName] net=[$net getName]"
$iterm disconnect
...
foreach pin {_393_/A _393_/Y} {
  puts "GREEN_V33_BTERM_LOW_V2 pin=$pin value=[get_property -object_type pin $pin activity]"
}
...
foreach pin {_393_/A _393_/Y} {
  puts "GREEN_V33_BTERM_HIGH_V2 pin=$pin value=[get_property -object_type pin $pin activity]"
}
