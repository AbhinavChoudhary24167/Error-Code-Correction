# Additive diagnostic: prove whether explicit per-pin activity changes power.
set out /repo/campaigns/iscas_sustainability_extension/green_v3_3_activity_complete_e5/diagnostics/activity_sensitivity
file mkdir $out
...
set_power_activity -pins {_393_/A _393_/B _393_/Y} -density 0.000001 -duty 0.1
...
foreach pin {_393_/A _393_/B _393_/Y} {
  puts "GREEN_V33_LOW_ACTIVITY pin=$pin value=[get_property -object_type pin $pin activity]"
}

set_power_activity -pins {_393_/A _393_/B _393_/Y} -density 0.1 -duty 0.9
...
foreach pin {_393_/A _393_/B _393_/Y} {
  puts "GREEN_V33_HIGH_ACTIVITY pin=$pin value=[get_property -object_type pin $pin activity]"
}
