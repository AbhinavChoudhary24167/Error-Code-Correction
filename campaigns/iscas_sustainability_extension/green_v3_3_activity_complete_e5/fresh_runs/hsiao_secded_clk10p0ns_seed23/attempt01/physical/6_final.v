module hsiao_matched_sram_top (ce,
 ...
 sky130_fd_sc_hd__xnor2_1 _415_ (.A(net256),
    .B(net570),
    .Y(_004_));
 sky130_fd_sc_hd__xnor2_1 _416_ (.A(net651),
    .B(net254),
    .Y(_005_));
 sky130_fd_sc_hd__xnor2_1 _417_ (.A(_004_),
    .B(_005_),
    .Y(_006_));
 sky130_fd_sc_hd__xnor2_1 _418_ (.A(net574),
    .B(net262),
    .Y(_007_));
 ...
 sky130_fd_sc_hd__xor2_1 _425_ (.A(net193),
    .B(\data_dout[54] ),
    .X(_014_));
 sky130_fd_sc_hd__xnor2_1 _426_ (.A(net604),
    .B(net606),
    .Y(_015_));
 sky130_fd_sc_hd__xnor2_1 _427_ (.A(net599),
    .B(\data_dout[52] ),
    .Y(_016_));
 ...
 sky130_fd_sc_hd__xnor2_1 _440_ (.A(\data_dout[43] ),
    .B(net625),
    .Y(_029_));
 sky130_fd_sc_hd__xnor3_1 _441_ (.A(net627),
    .B(net612),
    .C(net622),
    .X(_030_));
 ...
 sky130_fd_sc_hd__xnor2_1 _448_ (.A(net206),
    .B(net551),
    .Y(_037_));
 sky130_fd_sc_hd__xnor2_1 _449_ (.A(net592),
    .B(\data_dout[55] ),
    .Y(_038_));
 ...
 sky130_fd_sc_hd__xnor2_1 _451_ (.A(_036_),
    .B(_039_),
    .Y(_040_));
 sky130_fd_sc_hd__xnor2_1 _452_ (.A(net584),
    .B(net280),
    .Y(_041_));
 ...
 sky130_fd_sc_hd__xnor3_1 _461_ (.A(_040_),
    ...
    .C(_049_),
    .X(_050_));
 sky130_fd_sc_hd__clkinv_1 _462_ (.A(net707),
    .Y(_051_));
 ...
 sky130_fd_sc_hd__xnor2_1 _464_ (.A(net185),
    .B(_052_),
    .Y(_053_));
 sky130_fd_sc_hd__xnor2_1 _465_ (.A(net649),
    .B(net171),
    .Y(_054_));
 ...
 sky130_fd_sc_hd__xnor3_1 _468_ (.A(_006_),
    ...
    .C(_056_),
    .X(_057_));
 sky130_fd_sc_hd__xor2_4 _469_ (.A(net583),
    .B(\ecc_dout[4] ),
    .X(_058_));
 ...
 sky130_fd_sc_hd__xor2_1 _479_ (.A(net686),
    .B(net174),
    .X(_068_));
 sky130_fd_sc_hd__xnor2_1 _480_ (.A(net683),
    .B(net236),
    .Y(_069_));
 ...
 sky130_fd_sc_hd__xnor2_1 _494_ (.A(net203),
    .B(net620),
    .Y(_083_));
 sky130_fd_sc_hd__xnor2_1 _495_ (.A(net653),
    .B(net279),
    .Y(_084_));
 ...
 sky130_fd_sc_hd__xnor3_1 _498_ (.A(_076_),
    ...
    .C(_086_),
    .X(_087_));
 sky130_fd_sc_hd__xnor2_1 _499_ (.A(net564),
    .B(net659),
    .Y(_088_));
 ...
 sky130_fd_sc_hd__xor2_2 _526_ (.A(\data_dout[23] ),
    .B(\ecc_dout[3] ),
    .X(_115_));
 sky130_fd_sc_hd__xnor2_1 _527_ (.A(net635),
    .B(net216),
    .Y(_116_));
 ...
 sky130_fd_sc_hd__xnor3_1 _535_ (.A(_082_),
    ...
    .C(net712),
    .X(_124_));
 sky130_fd_sc_hd__xnor2_2 _536_ (.A(net252),
    .B(\ecc_dout[2] ),
    .Y(_125_));
 ...
 sky130_fd_sc_hd__nand2_1 _561_ (.A(_019_),
    .B(net708),
    .Y(_148_));
 sky130_fd_sc_hd__nor2_1 _562_ (.A(net707),
    .B(_148_),
    .Y(_149_));
 ...
 sky130_fd_sc_hd__nor4_1 _587_ (.A(_148_),
    ...
    .D(_168_),
    .Y(_169_));
 sky130_fd_sc_hd__nand2_1 _588_ (.A(net692),
    .B(_169_),
    .Y(_170_));
 ...
 sky130_fd_sc_hd__nor2_1 _600_ (.A(_019_),
    .B(net705),
    .Y(_179_));
 sky130_fd_sc_hd__and3_1 _601_ (.A(net707),
    .B(_065_),
    .C(_179_),
    .X(_180_));
 ...
 sky130_fd_sc_hd__xnor2_1 _667_ (.A(net240),
    .B(_221_),
    .Y(net119));
 sky130_fd_sc_hd__nor2_1 _668_ (.A(net707),
    .B(_065_),
    .Y(_222_));
 sky130_fd_sc_hd__nor2_1 _669_ (.A(_019_),
    .B(net708),
    .Y(_223_));
 sky130_fd_sc_hd__nand4_1 _670_ (.A(net693),
    .B(net692),
    .C(_222_),
    .D(_223_),
    .Y(_224_));
 ...
 sky130_fd_sc_hd__xnor2_1 _678_ (.A(net244),
    .B(_228_),
    .Y(net117));
 sky130_fd_sc_hd__and3_1 _679_ (.A(net707),
    .B(net706),
    .C(_223_),
    .X(_229_));
 ...
 sky130_fd_sc_hd__xnor3_1 _731_ (.A(net706),
    ...
    .C(_132_),
    .X(_261_));
 sky130_fd_sc_hd__xnor3_1 _732_ (.A(net707),
    .B(_253_),
    .C(_261_),
    .X(_262_));
 ...
 sky130_fd_sc_hd__or3b_1 _747_ (.A(_264_),
    ...
    .C_N(_276_),
    .X(net91));
 sky130_fd_sc_hd__nand2_1 _748_ (.A(net693),
    .B(net692),
    .Y(_277_));
 ...
 sky130_fd_sc_hd__xnor2_1 _752_ (.A(net175),
    .B(_279_),
    .Y(net152));
 sky130_fd_sc_hd__xor2_1 _753_ (.A(net735),
    .B(net726),
    .X(_280_));
 sky130_fd_sc_hd__xnor2_1 _754_ (.A(net47),
    .B(_280_),
    .Y(_281_));
 sky130_fd_sc_hd__xor2_1 _755_ (.A(net722),
    .B(net779),
    .X(_282_));
 sky130_fd_sc_hd__xor2_1 _756_ (.A(net729),
    .B(_282_),
    .X(_283_));
 ...
 sky130_fd_sc_hd__xnor2_1 _773_ (.A(_298_),
    .B(_299_),
    .Y(_300_));
 sky130_fd_sc_hd__xnor2_1 _774_ (.A(net720),
    .B(net25),
    .Y(_301_));
 ...
 sky130_fd_sc_hd__xor2_1 _783_ (.A(net753),
    .B(net742),
    .X(_309_));
 sky130_fd_sc_hd__xnor2_1 _784_ (.A(net717),
    .B(net788),
    .Y(_310_));
 sky130_fd_sc_hd__xnor2_1 _785_ (.A(net714),
    .B(_310_),
    .Y(_311_));
 ...
 sky130_fd_sc_hd__xnor2_1 _789_ (.A(_308_),
    .B(_314_),
    .Y(_315_));
 sky130_fd_sc_hd__xnor2_1 _790_ (.A(net729),
    .B(net782),
    .Y(_316_));
 sky130_fd_sc_hd__xnor2_1 _791_ (.A(_287_),
    .B(_316_),
    .Y(_317_));
 sky130_fd_sc_hd__xnor2_1 _792_ (.A(net747),
    .B(net724),
    .Y(_318_));
 ...
 sky130_fd_sc_hd__xnor2_1 _795_ (.A(_317_),
    .B(_320_),
    .Y(_321_));
 sky130_fd_sc_hd__xor2_1 _796_ (.A(net731),
    .B(net719),
    .X(_322_));
 sky130_fd_sc_hd__xor2_1 _797_ (.A(net735),
    .B(net770),
    .X(_323_));
 ...
 sky130_fd_sc_hd__xnor2_1 _806_ (.A(_327_),
    .B(_330_),
    .Y(_331_));
 sky130_fd_sc_hd__xnor2_1 _807_ (.A(net724),
    .B(net716),
    .Y(_332_));
 sky130_fd_sc_hd__xnor2_1 _808_ (.A(net733),
    .B(net58),
    .Y(_333_));
 ...
 sky130_fd_sc_hd__xnor2_1 _810_ (.A(_322_),
    .B(_334_),
    .Y(_335_));
 sky130_fd_sc_hd__xor2_1 _811_ (.A(net720),
    .B(net769),
    .X(_336_));
 sky130_fd_sc_hd__xnor2_1 _812_ (.A(net776),
    .B(net772),
    .Y(_337_));
 sky130_fd_sc_hd__xnor2_1 _813_ (.A(net722),
    .B(net775),
    .Y(_338_));
 ...
 sky130_fd_sc_hd__xnor2_1 _830_ (.A(_351_),
    .B(_353_),
    .Y(_354_));
 sky130_fd_sc_hd__xor2_1 _831_ (.A(net718),
    .B(net750),
    .X(_355_));
 sky130_fd_sc_hd__xnor2_1 _832_ (.A(net717),
    .B(net780),
    .Y(_356_));
 ...
 sky130_fd_sc_hd__xor2_1 _863_ (.A(_321_),
    .B(_331_),
    .X(_385_));
 sky130_fd_sc_hd__xnor2_2 _864_ (.A(net710),
    .B(_385_),
    .Y(\encoded_word[69] ));
 ...
 sky130_fd_sc_hd__xnor2_1 _872_ (.A(_362_),
    .B(_392_),
    .Y(_393_));
 sky130_fd_sc_hd__xor2_1 _873_ (.A(net738),
    .B(net737),
    .X(_394_));
 ...
 sky130_fd_sc_hd__xnor2_1 _883_ (.A(net761),
    .B(net746),
    .Y(_403_));
 sky130_fd_sc_hd__xnor2_1 _884_ (.A(net713),
    .B(_403_),
    .Y(_404_));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap169 (.A(net169),
    .X(net168));
 sky130_fd_sc_hd__clkbuf_1 max_cap170 (.A(net562),
    .X(net169));
 sky130_fd_sc_hd__clkbuf_2 max_cap171 (.A(net171),
    .X(net170));
 sky130_fd_sc_hd__clkbuf_2 max_cap172 (.A(net563),
    .X(net171));
 sky130_fd_sc_hd__clkbuf_2 max_cap173 (.A(net173),
    .X(net172));
 sky130_fd_sc_hd__clkbuf_2 max_cap174 (.A(net565),
    .X(net173));
 sky130_fd_sc_hd__clkbuf_1 max_cap175 (.A(net569),
    .X(net174));
 sky130_fd_sc_hd__clkbuf_2 max_cap176 (.A(net568),
    .X(net175));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap177 (.A(net576),
    .X(net176));
 sky130_fd_sc_hd__clkbuf_2 max_cap178 (.A(net575),
    .X(net177));
 sky130_fd_sc_hd__clkbuf_2 max_cap179 (.A(net179),
    .X(net178));
 sky130_fd_sc_hd__clkbuf_1 max_cap180 (.A(net579),
    .X(net179));
 sky130_fd_sc_hd__clkbuf_2 max_cap181 (.A(net181),
    .X(net180));
 sky130_fd_sc_hd__clkbuf_2 max_cap182 (.A(net581),
    .X(net181));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap185 (.A(net185),
    .X(net184));
 sky130_fd_sc_hd__clkbuf_1 max_cap186 (.A(net585),
    .X(net185));
 sky130_fd_sc_hd__clkbuf_1 max_cap187 (.A(net187),
    .X(net186));
 sky130_fd_sc_hd__clkbuf_2 max_cap188 (.A(net590),
    .X(net187));
 sky130_fd_sc_hd__clkbuf_2 max_cap189 (.A(net588),
    .X(net188));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap190 (.A(net591),
    .X(net189));
 sky130_fd_sc_hd__clkbuf_2 max_cap191 (.A(\data_dout[57] ),
    .X(net190));
 sky130_fd_sc_hd__clkbuf_1 max_cap192 (.A(net594),
    .X(net191));
 sky130_fd_sc_hd__clkbuf_2 max_cap193 (.A(net593),
    .X(net192));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap194 (.A(net596),
    .X(net193));
 sky130_fd_sc_hd__clkbuf_2 max_cap195 (.A(net595),
    .X(net194));
 sky130_fd_sc_hd__dlymetal6s2s_1 max_cap196 (.A(net598),
    .X(net195));
 sky130_fd_sc_hd__clkbuf_2 max_cap197 (.A(net597),
    .X(net196));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap198 (.A(net600),
    .X(net197));
 sky130_fd_sc_hd__clkbuf_2 max_cap199 (.A(\data_dout[53] ),
    .X(net198));
 sky130_fd_sc_hd__clkbuf_1 max_cap200 (.A(net602),
    .X(net199));
 sky130_fd_sc_hd__clkbuf_2 max_cap201 (.A(net601),
    .X(net200));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap202 (.A(\data_dout[51] ),
    .X(net201));
 sky130_fd_sc_hd__clkbuf_2 max_cap203 (.A(net603),
    .X(net202));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap204 (.A(\data_dout[50] ),
    .X(net203));
 sky130_fd_sc_hd__clkbuf_2 max_cap205 (.A(net605),
    .X(net204));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap209 (.A(\data_dout[48] ),
    .X(net208));
 sky130_fd_sc_hd__clkbuf_2 max_cap210 (.A(net613),
    .X(net209));
 sky130_fd_sc_hd__clkbuf_1 max_cap211 (.A(net616),
    .X(net210));
 sky130_fd_sc_hd__clkbuf_2 max_cap212 (.A(net615),
    .X(net211));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap213 (.A(\data_dout[46] ),
    .X(net212));
 sky130_fd_sc_hd__clkbuf_2 max_cap214 (.A(net617),
    .X(net213));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap215 (.A(\data_dout[45] ),
    .X(net214));
 sky130_fd_sc_hd__clkbuf_2 max_cap216 (.A(net619),
    .X(net215));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap217 (.A(net621),
    .X(net216));
 sky130_fd_sc_hd__clkbuf_2 max_cap218 (.A(\data_dout[44] ),
    .X(net217));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap219 (.A(net624),
    .X(net218));
 sky130_fd_sc_hd__clkbuf_2 max_cap220 (.A(net623),
    .X(net219));
 ...
 sky130_fd_sc_hd__clkbuf_1 max_cap223 (.A(\data_dout[41] ),
    .X(net222));
 sky130_fd_sc_hd__clkbuf_2 max_cap224 (.A(net626),
    .X(net223));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap225 (.A(net629),
    .X(net224));
 sky130_fd_sc_hd__clkbuf_2 max_cap226 (.A(net628),
    .X(net225));
 sky130_fd_sc_hd__clkbuf_2 max_cap227 (.A(net630),
    .X(net226));
 sky130_fd_sc_hd__clkbuf_2 max_cap228 (.A(net228),
    .X(net227));
 sky130_fd_sc_hd__clkbuf_1 max_cap229 (.A(net634),
    .X(net228));
 sky130_fd_sc_hd__clkbuf_2 max_cap230 (.A(net230),
    .X(net229));
 sky130_fd_sc_hd__clkbuf_2 max_cap231 (.A(net231),
    .X(net230));
 sky130_fd_sc_hd__clkbuf_1 max_cap232 (.A(\data_dout[38] ),
    .X(net231));
 sky130_fd_sc_hd__clkbuf_2 max_cap233 (.A(net233),
    .X(net232));
 sky130_fd_sc_hd__clkbuf_1 max_cap234 (.A(net636),
    .X(net233));
 sky130_fd_sc_hd__clkbuf_2 max_cap235 (.A(net235),
    .X(net234));
 sky130_fd_sc_hd__clkbuf_2 max_cap236 (.A(net637),
    .X(net235));
 sky130_fd_sc_hd__clkbuf_1 max_cap237 (.A(net639),
    .X(net236));
 sky130_fd_sc_hd__clkbuf_2 max_cap238 (.A(net638),
    .X(net237));
 sky130_fd_sc_hd__clkbuf_2 max_cap239 (.A(net239),
    .X(net238));
 sky130_fd_sc_hd__clkbuf_1 max_cap240 (.A(net640),
    .X(net239));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap258 (.A(net258),
    .X(net257));
 sky130_fd_sc_hd__clkbuf_1 max_cap259 (.A(net654),
    .X(net258));
 sky130_fd_sc_hd__clkbuf_1 max_cap260 (.A(net655),
    .X(net259));
 sky130_fd_sc_hd__clkbuf_2 max_cap261 (.A(net656),
    .X(net260));
 sky130_fd_sc_hd__clkbuf_2 max_cap262 (.A(net262),
    .X(net261));
 sky130_fd_sc_hd__clkbuf_2 max_cap263 (.A(net657),
    .X(net262));
 sky130_fd_sc_hd__clkbuf_2 max_cap264 (.A(net658),
    .X(net263));
 sky130_fd_sc_hd__clkbuf_2 max_cap265 (.A(\data_dout[22] ),
    .X(net264));
 sky130_fd_sc_hd__clkbuf_1 max_cap266 (.A(\data_dout[21] ),
    .X(net265));
 sky130_fd_sc_hd__clkbuf_2 max_cap267 (.A(net660),
    .X(net266));
 ...
 sky130_fd_sc_hd__clkbuf_1 max_cap271 (.A(net271),
    .X(net270));
 sky130_fd_sc_hd__clkbuf_1 max_cap272 (.A(net663),
    .X(net271));
 sky130_fd_sc_hd__clkbuf_2 max_cap273 (.A(net273),
    .X(net272));
 sky130_fd_sc_hd__clkbuf_1 max_cap274 (.A(net667),
    .X(net273));
 sky130_fd_sc_hd__clkbuf_2 max_cap275 (.A(net275),
    .X(net274));
 sky130_fd_sc_hd__clkbuf_1 max_cap276 (.A(net669),
    .X(net275));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap282 (.A(net672),
    .X(net281));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap283 (.A(net675),
    .X(net282));
 sky130_fd_sc_hd__clkbuf_2 max_cap284 (.A(net674),
    .X(net283));
 sky130_fd_sc_hd__clkbuf_1 max_cap285 (.A(net676),
    .X(net284));
 sky130_fd_sc_hd__clkbuf_2 max_cap286 (.A(net677),
    .X(net285));
 sky130_fd_sc_hd__clkbuf_1 max_cap287 (.A(net680),
    .X(net286));
 sky130_fd_sc_hd__clkbuf_2 max_cap288 (.A(net679),
    .X(net287));
 sky130_fd_sc_hd__clkbuf_2 max_cap289 (.A(net289),
    .X(net288));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap290 (.A(net681),
    .X(net289));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap291 (.A(net684),
    .X(net290));
 sky130_fd_sc_hd__clkbuf_2 max_cap292 (.A(net682),
    .X(net291));
 sky130_fd_sc_hd__clkbuf_2 max_cap293 (.A(net685),
    .X(net292));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap561 (.A(\data_dout[9] ),
    .X(net560));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap562 (.A(net562),
    .X(net561));
 sky130_fd_sc_hd__clkbuf_1 max_cap564 (.A(\data_dout[7] ),
    .X(net563));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap565 (.A(net565),
    .X(net564));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap575 (.A(net575),
    .X(net574));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap576 (.A(net576),
    .X(net575));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap580 (.A(net580),
    .X(net579));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap582 (.A(net582),
    .X(net581));
 sky130_fd_sc_hd__clkbuf_2 max_cap584 (.A(\data_dout[5] ),
    .X(net583));
 sky130_fd_sc_hd__clkbuf_1 max_cap585 (.A(net585),
    .X(net584));
 ...
 sky130_fd_sc_hd__clkbuf_1 max_cap592 (.A(net592),
    .X(net591));
 sky130_fd_sc_hd__clkbuf_1 max_cap593 (.A(\data_dout[57] ),
    .X(net592));
 sky130_fd_sc_hd__clkbuf_1 max_cap594 (.A(net594),
    .X(net593));
 sky130_fd_sc_hd__clkbuf_1 max_cap595 (.A(\data_dout[56] ),
    .X(net594));
 sky130_fd_sc_hd__clkbuf_1 max_cap596 (.A(net596),
    .X(net595));
 sky130_fd_sc_hd__clkbuf_1 max_cap597 (.A(\data_dout[55] ),
    .X(net596));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap598 (.A(net598),
    .X(net597));
 sky130_fd_sc_hd__clkbuf_1 max_cap599 (.A(\data_dout[54] ),
    .X(net598));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap600 (.A(net600),
    .X(net599));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap601 (.A(\data_dout[53] ),
    .X(net600));
 sky130_fd_sc_hd__clkbuf_1 max_cap602 (.A(net602),
    .X(net601));
 sky130_fd_sc_hd__clkbuf_1 max_cap603 (.A(\data_dout[52] ),
    .X(net602));
 sky130_fd_sc_hd__clkbuf_1 max_cap604 (.A(net604),
    .X(net603));
 sky130_fd_sc_hd__clkbuf_1 max_cap605 (.A(\data_dout[51] ),
    .X(net604));
 sky130_fd_sc_hd__clkbuf_1 max_cap606 (.A(net606),
    .X(net605));
 sky130_fd_sc_hd__clkbuf_1 max_cap607 (.A(\data_dout[50] ),
    .X(net606));
 sky130_fd_sc_hd__clkbuf_2 max_cap608 (.A(net608),
    .X(net607));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap613 (.A(\data_dout[49] ),
    .X(net612));
 sky130_fd_sc_hd__clkbuf_2 max_cap614 (.A(net614),
    .X(net613));
 sky130_fd_sc_hd__clkbuf_1 max_cap615 (.A(\data_dout[48] ),
    .X(net614));
 sky130_fd_sc_hd__clkbuf_1 max_cap616 (.A(net616),
    .X(net615));
 sky130_fd_sc_hd__clkbuf_1 max_cap617 (.A(\data_dout[47] ),
    .X(net616));
 sky130_fd_sc_hd__clkbuf_2 max_cap618 (.A(net618),
    .X(net617));
 sky130_fd_sc_hd__clkbuf_1 max_cap619 (.A(\data_dout[46] ),
    .X(net618));
 sky130_fd_sc_hd__clkbuf_1 max_cap620 (.A(net620),
    .X(net619));
 sky130_fd_sc_hd__clkbuf_1 max_cap621 (.A(\data_dout[45] ),
    .X(net620));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap622 (.A(net622),
    .X(net621));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap623 (.A(\data_dout[44] ),
    .X(net622));
 sky130_fd_sc_hd__clkbuf_1 max_cap624 (.A(net624),
    .X(net623));
 sky130_fd_sc_hd__clkbuf_1 max_cap625 (.A(\data_dout[43] ),
    .X(net624));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap626 (.A(\data_dout[42] ),
    .X(net625));
 sky130_fd_sc_hd__clkbuf_2 max_cap627 (.A(net627),
    .X(net626));
 sky130_fd_sc_hd__clkbuf_1 max_cap628 (.A(\data_dout[41] ),
    .X(net627));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap629 (.A(net629),
    .X(net628));
 sky130_fd_sc_hd__clkbuf_1 max_cap630 (.A(\data_dout[40] ),
    .X(net629));
 sky130_fd_sc_hd__clkbuf_1 max_cap631 (.A(net631),
    .X(net630));
 sky130_fd_sc_hd__clkbuf_1 max_cap635 (.A(\data_dout[39] ),
    .X(net634));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap636 (.A(\data_dout[38] ),
    .X(net635));
 sky130_fd_sc_hd__clkbuf_2 max_cap637 (.A(\data_dout[37] ),
    .X(net636));
 sky130_fd_sc_hd__clkbuf_1 max_cap638 (.A(\data_dout[36] ),
    .X(net637));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap639 (.A(net639),
    .X(net638));
 sky130_fd_sc_hd__clkbuf_2 max_cap640 (.A(\data_dout[35] ),
    .X(net639));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap641 (.A(\data_dout[34] ),
    .X(net640));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap642 (.A(\data_dout[33] ),
    .X(net641));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap643 (.A(\data_dout[32] ),
    .X(net642));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap644 (.A(\data_dout[31] ),
    .X(net643));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap645 (.A(\data_dout[30] ),
    .X(net644));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap646 (.A(net646),
    .X(net645));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap650 (.A(\data_dout[29] ),
    .X(net649));
 sky130_fd_sc_hd__clkbuf_1 max_cap651 (.A(net651),
    .X(net650));
 sky130_fd_sc_hd__clkbuf_4 max_cap652 (.A(\data_dout[28] ),
    .X(net651));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap653 (.A(\data_dout[27] ),
    .X(net652));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap654 (.A(\data_dout[26] ),
    .X(net653));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap655 (.A(\data_dout[25] ),
    .X(net654));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap656 (.A(\data_dout[24] ),
    .X(net655));
 sky130_fd_sc_hd__clkbuf_1 max_cap657 (.A(\data_dout[24] ),
    .X(net656));
 sky130_fd_sc_hd__buf_2 max_cap658 (.A(\data_dout[23] ),
    .X(net657));
 sky130_fd_sc_hd__clkbuf_1 max_cap659 (.A(net659),
    .X(net658));
 sky130_fd_sc_hd__clkbuf_4 max_cap660 (.A(\data_dout[22] ),
    .X(net659));
 sky130_fd_sc_hd__clkbuf_1 max_cap661 (.A(net661),
    .X(net660));
 sky130_fd_sc_hd__clkbuf_1 max_cap662 (.A(\data_dout[21] ),
    .X(net661));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap663 (.A(\data_dout[20] ),
    .X(net662));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap664 (.A(net664),
    .X(net663));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap668 (.A(\data_dout[19] ),
    .X(net667));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap669 (.A(net669),
    .X(net668));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap673 (.A(net673),
    .X(net672));
 sky130_fd_sc_hd__clkbuf_1 max_cap674 (.A(\data_dout[15] ),
    .X(net673));
 sky130_fd_sc_hd__clkbuf_1 max_cap675 (.A(net675),
    .X(net674));
 sky130_fd_sc_hd__clkbuf_1 max_cap676 (.A(\data_dout[14] ),
    .X(net675));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap677 (.A(net678),
    .X(net676));
 sky130_fd_sc_hd__clkbuf_2 max_cap678 (.A(net678),
    .X(net677));
 sky130_fd_sc_hd__clkbuf_1 max_cap680 (.A(net680),
    .X(net679));
 sky130_fd_sc_hd__clkbuf_2 max_cap681 (.A(\data_dout[12] ),
    .X(net680));
 sky130_fd_sc_hd__clkbuf_1 max_cap682 (.A(\data_dout[11] ),
    .X(net681));
 sky130_fd_sc_hd__clkbuf_1 max_cap683 (.A(net683),
    .X(net682));
 sky130_fd_sc_hd__clkbuf_2 max_cap684 (.A(net684),
    .X(net683));
 ...
 sky130_fd_sc_hd__buf_4 place692 (.A(_188_),
    .X(net691));
 sky130_fd_sc_hd__buf_4 place693 (.A(_166_),
    .X(net692));
 sky130_fd_sc_hd__buf_4 place694 (.A(_161_),
    .X(net693));
 ...
 sky130_fd_sc_hd__buf_4 place707 (.A(_063_),
    .X(net706));
 sky130_fd_sc_hd__buf_4 place708 (.A(_050_),
    .X(net707));
 sky130_fd_sc_hd__buf_4 place709 (.A(_033_),
    .X(net708));
 sky130_fd_sc_hd__buf_4 place710 (.A(\encoded_word[71] ),
    .X(net709));
 sky130_fd_sc_hd__buf_4 place711 (.A(_384_),
    .X(net710));
 sky130_fd_sc_hd__buf_4 place712 (.A(_305_),
    .X(net711));
 sky130_fd_sc_hd__buf_4 place713 (.A(_123_),
    .X(net712));
 sky130_fd_sc_hd__buf_4 place714 (.A(_375_),
    .X(net713));
 sky130_fd_sc_hd__buf_4 place715 (.A(_309_),
    .X(net714));
 sky130_fd_sc_hd__buf_4 place716 (.A(net90),
    .X(net715));
 sky130_fd_sc_hd__buf_4 place717 (.A(net88),
    .X(net716));
 sky130_fd_sc_hd__buf_4 place718 (.A(net87),
    .X(net717));
 sky130_fd_sc_hd__buf_4 place719 (.A(net86),
    .X(net718));
 sky130_fd_sc_hd__buf_4 place720 (.A(net85),
    .X(net719));
 sky130_fd_sc_hd__buf_4 place721 (.A(net721),
    .X(net720));
 sky130_fd_sc_hd__buf_4 place722 (.A(net84),
    .X(net721));
 sky130_fd_sc_hd__buf_4 place723 (.A(net723),
    .X(net722));
 sky130_fd_sc_hd__buf_4 place724 (.A(net83),
    .X(net723));
 sky130_fd_sc_hd__buf_4 place725 (.A(net725),
    .X(net724));
 sky130_fd_sc_hd__buf_4 place726 (.A(net82),
    .X(net725));
 sky130_fd_sc_hd__buf_4 place727 (.A(net727),
    .X(net726));
 sky130_fd_sc_hd__buf_4 place728 (.A(net81),
    .X(net727));
 sky130_fd_sc_hd__buf_4 place729 (.A(net80),
    .X(net728));
 sky130_fd_sc_hd__buf_4 place730 (.A(net730),
    .X(net729));
 sky130_fd_sc_hd__buf_4 place731 (.A(net79),
    .X(net730));
 sky130_fd_sc_hd__buf_4 place732 (.A(net732),
    .X(net731));
 sky130_fd_sc_hd__buf_4 place733 (.A(net78),
    .X(net732));
 sky130_fd_sc_hd__buf_4 place734 (.A(net734),
    .X(net733));
 sky130_fd_sc_hd__buf_4 place735 (.A(net77),
    .X(net734));
 sky130_fd_sc_hd__buf_4 place736 (.A(net736),
    .X(net735));
 sky130_fd_sc_hd__buf_4 place737 (.A(net76),
    .X(net736));
 sky130_fd_sc_hd__buf_4 place738 (.A(net75),
    .X(net737));
 sky130_fd_sc_hd__buf_4 place739 (.A(net739),
    .X(net738));
 sky130_fd_sc_hd__buf_4 place740 (.A(net74),
    .X(net739));
 sky130_fd_sc_hd__buf_4 place741 (.A(net73),
    .X(net740));
 sky130_fd_sc_hd__buf_4 place742 (.A(net72),
    .X(net741));
 ...
 sky130_fd_sc_hd__buf_4 place801 (.A(net16),
    .X(net800));
 sram22_256x64m4w8 u_data (.we(net715),
    .ce(net792),
 ...
 sram22_256x8m8w1 u_ecc0 (.we(net715),
    .ce(net792),
 ...
 sky130_fd_sc_hd__clkbuf_1 wire550 (.A(net550),
    .X(net549));
 sky130_fd_sc_hd__clkbuf_1 wire551 (.A(\ecc_dout[7] ),
    .X(net550));
 sky130_fd_sc_hd__clkbuf_1 wire552 (.A(net552),
    .X(net551));
 sky130_fd_sc_hd__clkbuf_1 wire553 (.A(net553),
    .X(net552));
 sky130_fd_sc_hd__clkbuf_1 wire554 (.A(\ecc_dout[5] ),
    .X(net553));
 sky130_fd_sc_hd__clkbuf_1 wire555 (.A(net555),
    .X(net554));
 sky130_fd_sc_hd__clkbuf_1 wire556 (.A(net556),
    .X(net555));
 sky130_fd_sc_hd__clkbuf_1 wire557 (.A(\ecc_dout[1] ),
    .X(net556));
 sky130_fd_sc_hd__clkbuf_1 wire558 (.A(net558),
    .X(net557));
 sky130_fd_sc_hd__clkbuf_1 wire559 (.A(net559),
    .X(net558));
 sky130_fd_sc_hd__clkbuf_1 wire560 (.A(\ecc_dout[0] ),
    .X(net559));
 sky130_fd_sc_hd__clkbuf_1 wire563 (.A(\data_dout[8] ),
    .X(net562));
 sky130_fd_sc_hd__clkbuf_1 wire566 (.A(net566),
    .X(net565));
 sky130_fd_sc_hd__clkbuf_1 wire567 (.A(net567),
    .X(net566));
 sky130_fd_sc_hd__clkbuf_1 wire568 (.A(\data_dout[6] ),
    .X(net567));
 sky130_fd_sc_hd__clkbuf_2 wire571 (.A(net571),
    .X(net570));
 sky130_fd_sc_hd__clkbuf_1 wire572 (.A(net572),
    .X(net571));
 sky130_fd_sc_hd__clkbuf_1 wire573 (.A(net573),
    .X(net572));
 sky130_fd_sc_hd__clkbuf_1 wire574 (.A(\data_dout[63] ),
    .X(net573));
 sky130_fd_sc_hd__clkbuf_1 wire577 (.A(net577),
    .X(net576));
 sky130_fd_sc_hd__clkbuf_1 wire578 (.A(net578),
    .X(net577));
 sky130_fd_sc_hd__clkbuf_1 wire579 (.A(\data_dout[62] ),
    .X(net578));
 sky130_fd_sc_hd__clkbuf_1 wire581 (.A(\data_dout[61] ),
    .X(net580));
 sky130_fd_sc_hd__clkbuf_1 wire583 (.A(\data_dout[60] ),
    .X(net582));
 sky130_fd_sc_hd__clkbuf_1 wire586 (.A(net586),
    .X(net585));
 sky130_fd_sc_hd__clkbuf_1 wire587 (.A(net587),
    .X(net586));
 sky130_fd_sc_hd__clkbuf_1 wire588 (.A(\data_dout[59] ),
    .X(net587));
 sky130_fd_sc_hd__clkbuf_1 wire591 (.A(\data_dout[58] ),
    .X(net590));
 sky130_fd_sc_hd__buf_6 wire609 (.A(net609),
    .X(net608));
 sky130_fd_sc_hd__clkbuf_1 wire610 (.A(net610),
    .X(net609));
 sky130_fd_sc_hd__clkbuf_1 wire611 (.A(net611),
    .X(net610));
 sky130_fd_sc_hd__clkbuf_1 wire612 (.A(\data_dout[4] ),
    .X(net611));
 sky130_fd_sc_hd__clkbuf_1 wire632 (.A(net632),
    .X(net631));
 sky130_fd_sc_hd__clkbuf_1 wire633 (.A(net633),
    .X(net632));
 sky130_fd_sc_hd__clkbuf_1 wire634 (.A(\data_dout[3] ),
    .X(net633));
 sky130_fd_sc_hd__clkbuf_1 wire647 (.A(net647),
    .X(net646));
 sky130_fd_sc_hd__clkbuf_1 wire648 (.A(net648),
    .X(net647));
 sky130_fd_sc_hd__clkbuf_1 wire649 (.A(\data_dout[2] ),
    .X(net648));
 sky130_fd_sc_hd__clkbuf_1 wire665 (.A(net665),
    .X(net664));
 sky130_fd_sc_hd__clkbuf_1 wire666 (.A(net666),
    .X(net665));
 sky130_fd_sc_hd__clkbuf_1 wire667 (.A(\data_dout[1] ),
    .X(net666));
 sky130_fd_sc_hd__clkbuf_1 wire670 (.A(\data_dout[18] ),
    .X(net669));
 sky130_fd_sc_hd__buf_6 wire679 (.A(\data_dout[13] ),
    .X(net678));
