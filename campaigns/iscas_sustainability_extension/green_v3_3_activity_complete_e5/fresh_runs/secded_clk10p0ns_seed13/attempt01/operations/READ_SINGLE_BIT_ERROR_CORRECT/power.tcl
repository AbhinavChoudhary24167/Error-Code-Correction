...
read_db /campaign-run/results/sky130hd/secded_matched_sram_top/clk10p0ns_seed13/6_final.odb
...
read_sdc /campaign-run/results/sky130hd/secded_matched_sram_top/clk10p0ns_seed13/6_final.sdc
read_spef /campaign-run/results/sky130hd/secded_matched_sram_top/clk10p0ns_seed13/6_final.spef
read_vcd -scope tb/dut /campaign-run/activity/READ_SINGLE_BIT_ERROR_CORRECT.vcd
source /campaign-run/activity/READ_SINGLE_BIT_ERROR_CORRECT.activity.tcl
puts "GREEN_V33_MACRO_OUTPUT_ACTIVITY_ROOT_ANNOTATIONS count=$green_v33_activity_root_annotation_count"
report_activity_annotation > /campaign-run/power/READ_SINGLE_BIT_ERROR_CORRECT/annotation.rpt
report_activity_annotation -report_annotated > /campaign-run/power/READ_SINGLE_BIT_ERROR_CORRECT/annotated.rpt
report_activity_annotation -report_unannotated > /campaign-run/power/READ_SINGLE_BIT_ERROR_CORRECT/unannotated.rpt
report_power -digits 12 > /campaign-run/power/READ_SINGLE_BIT_ERROR_CORRECT/power.rpt
report_power -format json > /campaign-run/power/READ_SINGLE_BIT_ERROR_CORRECT/power.json
report_power -instances [get_cells {u_data u_ecc0}] -digits 12 > /campaign-run/power/READ_SINGLE_BIT_ERROR_CORRECT/macros.power.rpt
puts "GREEN_V33_POWER_COMPLETE architecture=secded_matched_sram_top operation=READ_SINGLE_BIT_ERROR_CORRECT"
