...
source /campaign-run/activity/WRITE_CLEAN.activity.tcl
puts "GREEN_V33_MACRO_OUTPUT_ACTIVITY_ROOT_ANNOTATIONS count=$green_v33_activity_root_annotation_count"
report_activity_annotation > /campaign-run/power/WRITE_CLEAN/annotation.rpt
report_activity_annotation -report_annotated > /campaign-run/power/WRITE_CLEAN/annotated.rpt
report_activity_annotation -report_unannotated > /campaign-run/power/WRITE_CLEAN/unannotated.rpt
report_power -digits 12 > /campaign-run/power/WRITE_CLEAN/power.rpt
report_power -format json > /campaign-run/power/WRITE_CLEAN/power.json
report_power -instances [get_cells {u_data u_ecc0}] -digits 12 > /campaign-run/power/WRITE_CLEAN/macros.power.rpt
puts "GREEN_V33_POWER_COMPLETE architecture=hsiao_matched_sram_top operation=WRITE_CLEAN"
