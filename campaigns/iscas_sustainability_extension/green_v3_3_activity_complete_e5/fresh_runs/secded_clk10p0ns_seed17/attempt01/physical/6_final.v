module secded_matched_sram_top (ce,
 ...
 sky130_fd_sc_hd__xnor2_1 _395_ (.A(_000_),
    .B(_001_),
    .Y(_002_));
 sky130_fd_sc_hd__xor2_1 _396_ (.A(net601),
    .B(\data_dout[43] ),
    .X(_003_));
 ...
 sky130_fd_sc_hd__xnor2_1 _398_ (.A(\data_dout[58] ),
    .B(\data_dout[59] ),
    .Y(_005_));
 sky130_fd_sc_hd__xnor2_1 _399_ (.A(net581),
    .B(net579),
    .Y(_006_));
 ...
 sky130_fd_sc_hd__xnor3_2 _410_ (.A(\data_dout[62] ),
    ...
    .C(net585),
    .X(_017_));
 sky130_fd_sc_hd__xnor2_1 _411_ (.A(net573),
    .B(net584),
    .Y(_018_));
 ...
 sky130_fd_sc_hd__xnor3_1 _421_ (.A(_025_),
    ...
    .C(_027_),
    .X(_028_));
 sky130_fd_sc_hd__xnor2_1 _422_ (.A(net626),
    .B(net265),
    .Y(_029_));
 ...
 sky130_fd_sc_hd__xnor2_2 _424_ (.A(_028_),
    .B(_030_),
    .Y(_031_));
 sky130_fd_sc_hd__xnor2_1 _425_ (.A(net614),
    .B(net257),
    .Y(_032_));
 sky130_fd_sc_hd__xnor2_1 _426_ (.A(net616),
    .B(net255),
    .Y(_033_));
 ...
 sky130_fd_sc_hd__xor2_1 _437_ (.A(_041_),
    .B(_043_),
    .X(_044_));
 sky130_fd_sc_hd__xnor2_2 _438_ (.A(net588),
    .B(\data_dout[3] ),
    .Y(_045_));
 sky130_fd_sc_hd__xnor2_1 _439_ (.A(net575),
    .B(net234),
    .Y(_046_));
 ...
 sky130_fd_sc_hd__xnor3_2 _444_ (.A(_019_),
    ...
    .C(_050_),
    .X(_051_));
 sky130_fd_sc_hd__xor2_1 _445_ (.A(net685),
    .B(_051_),
    .X(_052_));
 sky130_fd_sc_hd__xor2_1 _446_ (.A(net625),
    .B(net170),
    .X(_053_));
 ...
 sky130_fd_sc_hd__xnor2_1 _470_ (.A(_073_),
    .B(_076_),
    .Y(_077_));
 sky130_fd_sc_hd__xor2_2 _471_ (.A(net633),
    .B(net569),
    .X(_078_));
 ...
 sky130_fd_sc_hd__nand3_2 _475_ (.A(_052_),
    ...
    .C(_081_),
    .Y(_082_));
 sky130_fd_sc_hd__xnor2_2 _476_ (.A(net685),
    .B(_051_),
    .Y(_083_));
 ...
 sky130_fd_sc_hd__xnor2_1 _481_ (.A(_078_),
    .B(net691),
    .Y(_088_));
 sky130_fd_sc_hd__xnor3_1 _482_ (.A(net634),
    .B(net636),
    .C(\data_dout[8] ),
    .X(_089_));
 ...
 sky130_fd_sc_hd__xor2_1 _486_ (.A(net186),
    .B(net190),
    .X(_093_));
 sky130_fd_sc_hd__xnor2_1 _487_ (.A(net582),
    .B(net188),
    .Y(_094_));
 ...
 sky130_fd_sc_hd__a21oi_2 _491_ (.A1(_082_),
    ...
    .B1(net679),
    .Y(_098_));
 sky130_fd_sc_hd__mux2i_1 _492_ (.A0(net686),
    .A1(_037_),
    .S(_098_),
    .Y(_099_));
 sky130_fd_sc_hd__xor2_4 _493_ (.A(_016_),
    .B(net666),
    .X(_100_));
 ...
 sky130_fd_sc_hd__nand3_1 _496_ (.A(_083_),
    ...
    .C(_081_),
    .Y(_103_));
 sky130_fd_sc_hd__o21ai_1 _497_ (.A1(net680),
    .A2(_102_),
    .B1(_103_),
    .Y(_104_));
 ...
 sky130_fd_sc_hd__xnor2_2 _503_ (.A(_107_),
    .B(_109_),
    .Y(_110_));
 sky130_fd_sc_hd__nand3b_1 _505_ (.A_N(net686),
    .B(_037_),
    .C(_016_),
    .Y(_112_));
 sky130_fd_sc_hd__xor2_1 _506_ (.A(_031_),
    .B(_036_),
    .X(_113_));
 sky130_fd_sc_hd__nand3b_1 _507_ (.A_N(_016_),
    .B(_113_),
    .C(net686),
    .Y(_114_));
 sky130_fd_sc_hd__a21oi_1 _508_ (.A1(_112_),
    ...
    .B1(net679),
    .Y(_115_));
 sky130_fd_sc_hd__xor2_1 _509_ (.A(net615),
    .B(\data_dout[0] ),
    .X(_116_));
 sky130_fd_sc_hd__xnor2_1 _510_ (.A(net627),
    .B(\ecc_dout[7] ),
    .Y(_117_));
 ...
 sky130_fd_sc_hd__xnor2_1 _514_ (.A(_011_),
    .B(_047_),
    .Y(_121_));
 sky130_fd_sc_hd__xnor2_1 _515_ (.A(net686),
    .B(_121_),
    .Y(_122_));
 ...
 sky130_fd_sc_hd__xnor2_2 _517_ (.A(_092_),
    .B(_123_),
    .Y(_124_));
 sky130_fd_sc_hd__o21a_1 _518_ (.A1(net683),
    .A2(_115_),
    .B1(net670),
    .X(net91));
 sky130_fd_sc_hd__and2_1 _520_ (.A(net671),
    .B(net91),
    .X(_126_));
 ...
 sky130_fd_sc_hd__xnor2_1 _533_ (.A(_128_),
    .B(_138_),
    .Y(_139_));
 sky130_fd_sc_hd__nand2b_1 _534_ (.A_N(net679),
    .B(net678),
    .Y(_140_));
 ...
 sky130_fd_sc_hd__xnor2_1 _541_ (.A(net207),
    .B(_146_),
    .Y(net131));
 sky130_fd_sc_hd__nand2_1 _542_ (.A(net679),
    .B(net678),
    .Y(_147_));
 sky130_fd_sc_hd__nor2_1 _543_ (.A(net677),
    .B(_147_),
    .Y(_148_));
 ...
 sky130_fd_sc_hd__or2b_1 _549_ (.A(_141_),
    .B_N(_115_),
    .X(_153_));
 sky130_fd_sc_hd__xnor2_1 _550_ (.A(net683),
    .B(_153_),
    .Y(_154_));
 sky130_fd_sc_hd__nor2_1 _551_ (.A(_140_),
    .B(net677),
    .Y(_155_));
 sky130_fd_sc_hd__and2_2 _552_ (.A(net671),
    .B(net665),
    .X(_156_));
 ...
 sky130_fd_sc_hd__o21ai_0 _556_ (.A1(_061_),
    ...
    .B1(_158_),
    .Y(_159_));
 sky130_fd_sc_hd__and3_1 _557_ (.A(net683),
    .B(net670),
    .C(net669),
    .X(_160_));
 sky130_fd_sc_hd__xnor2_1 _559_ (.A(_016_),
    .B(net686),
    .Y(_162_));
 sky130_fd_sc_hd__nor3_1 _560_ (.A(net677),
    .B(_147_),
    .C(_162_),
    .Y(_163_));
 ...
 sky130_fd_sc_hd__and3_1 _564_ (.A(_115_),
    ...
    .C(_165_),
    .X(_166_));
 sky130_fd_sc_hd__nor3_1 _566_ (.A(net679),
    .B(net678),
    .C(net677),
    .Y(_168_));
 sky130_fd_sc_hd__and3_1 _567_ (.A(net671),
    .B(_166_),
    .C(net668),
    .X(_169_));
 sky130_fd_sc_hd__xor2_1 _568_ (.A(net567),
    .B(_169_),
    .X(net146));
 ...
 sky130_fd_sc_hd__and2_1 _576_ (.A(net91),
    .B(net669),
    .X(_176_));
 sky130_fd_sc_hd__nand3_1 _578_ (.A(net659),
    .B(net665),
    .C(_176_),
    .Y(_178_));
 sky130_fd_sc_hd__xnor2_1 _579_ (.A(net236),
    .B(_178_),
    .Y(net116));
 sky130_fd_sc_hd__xor2_1 _581_ (.A(net683),
    .B(_115_),
    .X(_180_));
 ...
 sky130_fd_sc_hd__nand2_1 _588_ (.A(_083_),
    .B(_085_),
    .Y(_185_));
 sky130_fd_sc_hd__nand2_1 _589_ (.A(net680),
    .B(_081_),
    .Y(_186_));
 sky130_fd_sc_hd__o22ai_1 _590_ (.A1(net680),
    .A2(_185_),
    .B1(_186_),
    .B2(_083_),
    .Y(_187_));
 sky130_fd_sc_hd__and3_1 _591_ (.A(net683),
    .B(net670),
    .C(_187_),
    .X(_188_));
 ...
 sky130_fd_sc_hd__xnor2_1 _594_ (.A(net262),
    .B(_190_),
    .Y(net101));
 sky130_fd_sc_hd__nor3_1 _596_ (.A(net679),
    .B(net678),
    .C(_170_),
    .Y(_192_));
 sky130_fd_sc_hd__and2_1 _597_ (.A(_112_),
    .B(_114_),
    .X(_193_));
 sky130_fd_sc_hd__xnor2_1 _598_ (.A(net683),
    .B(_193_),
    .Y(_194_));
 ...
 sky130_fd_sc_hd__xnor2_1 _600_ (.A(net215),
    .B(_195_),
    .Y(net128));
 sky130_fd_sc_hd__and2_2 _601_ (.A(net668),
    .B(_187_),
    .X(_196_));
 sky130_fd_sc_hd__nand3_1 _602_ (.A(_100_),
    .B(net91),
    .C(_196_),
    .Y(_197_));
 sky130_fd_sc_hd__xnor2_2 _603_ (.A(net233),
    .B(_197_),
    .Y(net117));
 sky130_fd_sc_hd__and3_1 _604_ (.A(net683),
    .B(net671),
    .C(net670),
    .X(_198_));
 sky130_fd_sc_hd__nand2_1 _606_ (.A(net664),
    .B(_198_),
    .Y(_200_));
 sky130_fd_sc_hd__xnor2_1 _607_ (.A(net283),
    .B(_200_),
    .Y(net153));
 sky130_fd_sc_hd__and2_2 _608_ (.A(net665),
    .B(_187_),
    .X(_201_));
 ...
 sky130_fd_sc_hd__xnor2_1 _610_ (.A(net231),
    .B(_202_),
    .Y(net118));
 sky130_fd_sc_hd__nor2_1 _611_ (.A(net677),
    .B(_173_),
    .Y(_203_));
 sky130_fd_sc_hd__nand2_1 _612_ (.A(net662),
    .B(net661),
    .Y(_204_));
 ...
 sky130_fd_sc_hd__xnor2_1 _616_ (.A(net174),
    .B(_206_),
    .Y(net147));
 sky130_fd_sc_hd__nand3_1 _617_ (.A(net665),
    .B(net669),
    .C(_166_),
    .Y(_207_));
 sky130_fd_sc_hd__xnor2_1 _618_ (.A(net564),
    .B(_207_),
    .Y(net150));
 ...
 sky130_fd_sc_hd__nand2_1 _633_ (.A(_166_),
    .B(_196_),
    .Y(_216_));
 sky130_fd_sc_hd__xnor2_1 _634_ (.A(net563),
    .B(_216_),
    .Y(net151));
 ...
 sky130_fd_sc_hd__xnor2_1 _642_ (.A(net254),
    .B(_220_),
    .Y(net106));
 sky130_fd_sc_hd__nand3_1 _643_ (.A(net669),
    .B(_166_),
    .C(net668),
    .Y(_221_));
 ...
 sky130_fd_sc_hd__xnor2_1 _654_ (.A(net184),
    .B(_227_),
    .Y(net144));
 sky130_fd_sc_hd__nor2_1 _655_ (.A(net679),
    .B(net678),
    .Y(_228_));
 ...
 sky130_fd_sc_hd__xnor2_1 _683_ (.A(net205),
    .B(_243_),
    .Y(net133));
 sky130_fd_sc_hd__nand2_1 _684_ (.A(net664),
    .B(_224_),
    .Y(_244_));
 ...
 sky130_fd_sc_hd__xnor2_1 _693_ (.A(net224),
    .B(_248_),
    .Y(net122));
 sky130_fd_sc_hd__nand2_1 _694_ (.A(net663),
    .B(_224_),
    .Y(_249_));
 ...
 sky130_fd_sc_hd__xnor2_1 _705_ (.A(net256),
    .B(_254_),
    .Y(net105));
 sky130_fd_sc_hd__xor2_2 _706_ (.A(net704),
    .B(net706),
    .X(_255_));
 sky130_fd_sc_hd__xnor2_1 _707_ (.A(net711),
    .B(net710),
    .Y(_256_));
 sky130_fd_sc_hd__xnor2_1 _708_ (.A(_255_),
    .B(_256_),
    .Y(_257_));
 sky130_fd_sc_hd__xor2_1 _709_ (.A(net709),
    .B(net707),
    .X(_258_));
 sky130_fd_sc_hd__xnor2_2 _710_ (.A(net705),
    .B(_258_),
    .Y(_259_));
 sky130_fd_sc_hd__xnor2_4 _711_ (.A(_257_),
    .B(_259_),
    .Y(\encoded_word[63] ));
 sky130_fd_sc_hd__xor2_1 _712_ (.A(net734),
    .B(net736),
    .X(_260_));
 sky130_fd_sc_hd__xnor2_1 _713_ (.A(net735),
    .B(_260_),
    .Y(_261_));
 sky130_fd_sc_hd__xor2_1 _714_ (.A(net737),
    .B(net739),
    .X(_262_));
 sky130_fd_sc_hd__xnor2_1 _715_ (.A(net738),
    .B(net740),
    .Y(_263_));
 ...
 sky130_fd_sc_hd__xnor2_1 _717_ (.A(_261_),
    .B(_264_),
    .Y(_265_));
 sky130_fd_sc_hd__xnor2_1 _718_ (.A(net732),
    .B(_265_),
    .Y(_266_));
 ...
 sky130_fd_sc_hd__xor2_4 _720_ (.A(net76),
    .B(net713),
    .X(_268_));
 sky130_fd_sc_hd__xnor2_1 _721_ (.A(net719),
    .B(net722),
    .Y(_269_));
 sky130_fd_sc_hd__xnor2_1 _722_ (.A(_268_),
    .B(_269_),
    .Y(_270_));
 sky130_fd_sc_hd__xor2_1 _723_ (.A(net716),
    .B(net720),
    .X(_271_));
 sky130_fd_sc_hd__xnor2_1 _724_ (.A(net718),
    .B(_271_),
    .Y(_272_));
 ...
 sky130_fd_sc_hd__xnor2_1 _726_ (.A(_267_),
    .B(net688),
    .Y(_274_));
 sky130_fd_sc_hd__xor2_1 _727_ (.A(net726),
    .B(net724),
    .X(_275_));
 sky130_fd_sc_hd__xnor2_1 _728_ (.A(net729),
    .B(net731),
    .Y(_276_));
 sky130_fd_sc_hd__xnor2_1 _729_ (.A(net727),
    .B(net730),
    .Y(_277_));
 ...
 sky130_fd_sc_hd__xnor2_2 _731_ (.A(_275_),
    .B(_278_),
    .Y(_279_));
 sky130_fd_sc_hd__xor2_1 _732_ (.A(net743),
    .B(net747),
    .X(_280_));
 sky130_fd_sc_hd__xnor2_1 _733_ (.A(net714),
    .B(net741),
    .Y(_281_));
 sky130_fd_sc_hd__xnor2_1 _734_ (.A(_280_),
    .B(_281_),
    .Y(_282_));
 sky130_fd_sc_hd__xnor2_1 _735_ (.A(net745),
    .B(net748),
    .Y(_283_));
 sky130_fd_sc_hd__xnor2_1 _736_ (.A(net742),
    .B(net746),
    .Y(_284_));
 ...
 sky130_fd_sc_hd__xnor2_1 _739_ (.A(_279_),
    .B(_286_),
    .Y(_287_));
 sky130_fd_sc_hd__xnor2_1 _740_ (.A(net681),
    .B(_287_),
    .Y(_288_));
 sky130_fd_sc_hd__xnor2_1 _741_ (.A(net682),
    .B(_288_),
    .Y(\encoded_word[31] ));
 sky130_fd_sc_hd__xnor2_1 _742_ (.A(net764),
    .B(net763),
    .Y(_289_));
 sky130_fd_sc_hd__xnor2_1 _743_ (.A(net758),
    .B(net761),
    .Y(_290_));
 sky130_fd_sc_hd__xnor2_1 _744_ (.A(_289_),
    .B(_290_),
    .Y(_291_));
 sky130_fd_sc_hd__xnor2_1 _745_ (.A(net759),
    .B(net762),
    .Y(_292_));
 sky130_fd_sc_hd__xnor2_1 _746_ (.A(net757),
    .B(net760),
    .Y(_293_));
 ...
 sky130_fd_sc_hd__xnor2_1 _748_ (.A(_291_),
    .B(_294_),
    .Y(_295_));
 sky130_fd_sc_hd__xnor2_1 _749_ (.A(net681),
    .B(_295_),
    .Y(_296_));
 sky130_fd_sc_hd__xor2_1 _750_ (.A(net750),
    .B(net754),
    .X(_297_));
 sky130_fd_sc_hd__xnor2_1 _751_ (.A(net749),
    .B(_297_),
    .Y(_298_));
 sky130_fd_sc_hd__xor2_1 _752_ (.A(net714),
    .B(net756),
    .X(_299_));
 sky130_fd_sc_hd__xnor2_1 _753_ (.A(net753),
    .B(net752),
    .Y(_300_));
 ...
 sky130_fd_sc_hd__xnor2_1 _755_ (.A(_298_),
    .B(_301_),
    .Y(_302_));
 sky130_fd_sc_hd__xnor2_1 _756_ (.A(net751),
    .B(_302_),
    .Y(_303_));
 ...
 sky130_fd_sc_hd__xor2_1 _758_ (.A(_296_),
    .B(_304_),
    .X(\encoded_word[15] ));
 sky130_fd_sc_hd__xor2_1 _759_ (.A(net721),
    .B(net708),
    .X(_305_));
 sky130_fd_sc_hd__xnor2_1 _760_ (.A(net765),
    .B(net702),
    .Y(_306_));
 sky130_fd_sc_hd__xnor2_1 _761_ (.A(_305_),
    .B(_306_),
    .Y(_307_));
 sky130_fd_sc_hd__xor2_1 _762_ (.A(net700),
    .B(net703),
    .X(_308_));
 sky130_fd_sc_hd__xnor2_1 _763_ (.A(net701),
    .B(_308_),
    .Y(_309_));
 sky130_fd_sc_hd__xnor2_1 _764_ (.A(_307_),
    .B(_309_),
    .Y(_310_));
 sky130_fd_sc_hd__xnor2_1 _765_ (.A(net688),
    .B(_310_),
    .Y(_311_));
 sky130_fd_sc_hd__xnor2_1 _766_ (.A(_303_),
    .B(_311_),
    .Y(_312_));
 sky130_fd_sc_hd__xnor2_1 _767_ (.A(net757),
    .B(net682),
    .Y(_313_));
 sky130_fd_sc_hd__xnor2_2 _768_ (.A(_312_),
    .B(_313_),
    .Y(\encoded_word[7] ));
 sky130_fd_sc_hd__xor2_1 _769_ (.A(net751),
    .B(net36),
    .X(_314_));
 sky130_fd_sc_hd__xnor2_1 _770_ (.A(net714),
    .B(net749),
    .Y(_315_));
 sky130_fd_sc_hd__xnor2_1 _771_ (.A(_314_),
    .B(_315_),
    .Y(_316_));
 sky130_fd_sc_hd__xnor2_1 _772_ (.A(net733),
    .B(net744),
    .Y(_317_));
 sky130_fd_sc_hd__xnor2_1 _773_ (.A(net750),
    .B(net752),
    .Y(_318_));
 ...
 sky130_fd_sc_hd__xnor2_1 _775_ (.A(_316_),
    .B(_319_),
    .Y(_320_));
 sky130_fd_sc_hd__xor2_1 _776_ (.A(net723),
    .B(net745),
    .X(_321_));
 sky130_fd_sc_hd__xnor2_1 _777_ (.A(net707),
    .B(net73),
    .Y(_322_));
 sky130_fd_sc_hd__xnor2_1 _778_ (.A(_321_),
    .B(_322_),
    .Y(_323_));
 sky130_fd_sc_hd__xnor2_1 _779_ (.A(net758),
    .B(net765),
    .Y(_324_));
 sky130_fd_sc_hd__xnor2_1 _780_ (.A(net59),
    .B(net741),
    .Y(_325_));
 sky130_fd_sc_hd__xnor2_1 _781_ (.A(net698),
    .B(_325_),
    .Y(_326_));
 sky130_fd_sc_hd__xnor2_1 _782_ (.A(_323_),
    .B(_326_),
    .Y(_327_));
 sky130_fd_sc_hd__xor2_1 _783_ (.A(net761),
    .B(net702),
    .X(_328_));
 ...
 sky130_fd_sc_hd__xnor2_1 _786_ (.A(_327_),
    .B(_330_),
    .Y(_331_));
 sky130_fd_sc_hd__xor2_1 _787_ (.A(net759),
    .B(net700),
    .X(_332_));
 ...
 sky130_fd_sc_hd__xnor2_1 _791_ (.A(_333_),
    .B(_335_),
    .Y(_336_));
 sky130_fd_sc_hd__xnor2_1 _792_ (.A(net725),
    .B(net701),
    .Y(_337_));
 sky130_fd_sc_hd__xnor2_1 _793_ (.A(net743),
    .B(net760),
    .Y(_338_));
 ...
 sky130_fd_sc_hd__xnor2_2 _798_ (.A(_320_),
    .B(_342_),
    .Y(\encoded_word[3] ));
 sky130_fd_sc_hd__xor2_1 _799_ (.A(net703),
    .B(net733),
    .X(_343_));
 sky130_fd_sc_hd__xnor2_1 _800_ (.A(net746),
    .B(net762),
    .Y(_344_));
 ...
 sky130_fd_sc_hd__xnor2_1 _803_ (.A(_345_),
    .B(_346_),
    .Y(_347_));
 sky130_fd_sc_hd__xor2_1 _804_ (.A(net753),
    .B(net25),
    .X(_348_));
 ...
 sky130_fd_sc_hd__xnor2_1 _807_ (.A(_347_),
    .B(_350_),
    .Y(_351_));
 sky130_fd_sc_hd__xnor2_1 _808_ (.A(net764),
    .B(net721),
    .Y(_352_));
 sky130_fd_sc_hd__xnor2_1 _809_ (.A(net712),
    .B(net720),
    .Y(_353_));
 sky130_fd_sc_hd__xnor2_1 _810_ (.A(net696),
    .B(net695),
    .Y(_354_));
 ...
 sky130_fd_sc_hd__xnor2_1 _813_ (.A(_354_),
    .B(_356_),
    .Y(_357_));
 sky130_fd_sc_hd__xor2_1 _814_ (.A(net748),
    .B(net756),
    .X(_358_));
 sky130_fd_sc_hd__xnor2_1 _815_ (.A(net735),
    .B(_358_),
    .Y(_359_));
 ...
 sky130_fd_sc_hd__xnor2_2 _819_ (.A(_351_),
    .B(_362_),
    .Y(\encoded_word[0] ));
 sky130_fd_sc_hd__xnor2_1 _820_ (.A(net708),
    .B(net744),
    .Y(_363_));
 sky130_fd_sc_hd__xnor2_1 _821_ (.A(net763),
    .B(_363_),
    .Y(_364_));
 sky130_fd_sc_hd__xnor2_1 _822_ (.A(_298_),
    .B(_364_),
    .Y(_365_));
 sky130_fd_sc_hd__xor2_1 _823_ (.A(net729),
    .B(net738),
    .X(_366_));
 sky130_fd_sc_hd__xnor2_1 _824_ (.A(net710),
    .B(net719),
    .Y(_367_));
 sky130_fd_sc_hd__xnor2_1 _825_ (.A(_366_),
    .B(_367_),
    .Y(_368_));
 sky130_fd_sc_hd__xnor2_1 _826_ (.A(net737),
    .B(net747),
    .Y(_369_));
 sky130_fd_sc_hd__xnor2_1 _827_ (.A(net704),
    .B(net734),
    .Y(_370_));
 ...
 sky130_fd_sc_hd__xnor2_1 _842_ (.A(net180),
    .B(_379_),
    .Y(net148));
 sky130_fd_sc_hd__nor4_2 _843_ (.A(net679),
    .B(_141_),
    .C(net678),
    .D(_208_),
    .Y(_380_));
 sky130_fd_sc_hd__nor2_1 _844_ (.A(net670),
    .B(_380_),
    .Y(net92));
 ...
 sky130_fd_sc_hd__xnor2_1 _846_ (.A(net167),
    .B(_381_),
    .Y(net152));
 sky130_fd_sc_hd__xor2_1 _847_ (.A(net754),
    .B(_299_),
    .X(_382_));
 ...
 sky130_fd_sc_hd__xnor3_1 _851_ (.A(_296_),
    ...
    .C(_385_),
    .X(_386_));
 sky130_fd_sc_hd__xnor2_1 _852_ (.A(net674),
    .B(net673),
    .Y(_387_));
 sky130_fd_sc_hd__xnor2_1 _853_ (.A(_386_),
    .B(_387_),
    .Y(_388_));
 sky130_fd_sc_hd__xor2_1 _854_ (.A(net676),
    .B(net675),
    .X(_389_));
 sky130_fd_sc_hd__xnor2_2 _855_ (.A(_388_),
    .B(_389_),
    .Y(\encoded_word[71] ));
 sky130_fd_sc_hd__nand2_1 _856_ (.A(net665),
    .B(_160_),
    .Y(_390_));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold777 (.A(net780),
    .X(net776));
 sky130_fd_sc_hd__buf_4 hold778 (.A(net782),
    .X(net777));
 sky130_fd_sc_hd__dlygate4sd3_1 hold779 (.A(net289),
    .X(net778));
 sky130_fd_sc_hd__buf_16 hold780 (.A(net637),
    .X(net779));
 sky130_fd_sc_hd__dlygate4sd3_1 hold781 (.A(net786),
    .X(net780));
 sky130_fd_sc_hd__dlygate4sd3_1 hold782 (.A(net776),
    .X(net781));
 sky130_fd_sc_hd__dlygate4sd3_1 hold783 (.A(net89),
    .X(net782));
 sky130_fd_sc_hd__buf_4 hold784 (.A(net777),
    .X(net783));
 sky130_fd_sc_hd__dlygate4sd3_1 hold785 (.A(net288),
    .X(net784));
 sky130_fd_sc_hd__buf_16 hold786 (.A(net638),
    .X(net785));
 sky130_fd_sc_hd__dlygate4sd3_1 hold787 (.A(rstb),
    .X(net786));
 ...
 sky130_fd_sc_hd__buf_2 input89 (.A(payload_in[9]),
    .X(net88));
 sky130_fd_sc_hd__clkbuf_16 input90 (.A(net781),
    .X(net89));
 sky130_fd_sc_hd__buf_2 input91 (.A(we),
    .X(net90));
 sky130_fd_sc_hd__clkbuf_2 max_cap168 (.A(net168),
    .X(net167));
 sky130_fd_sc_hd__clkbuf_2 max_cap169 (.A(net562),
    .X(net168));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap192 (.A(\data_dout[5] ),
    .X(net191));
 sky130_fd_sc_hd__clkbuf_1 max_cap193 (.A(net576),
    .X(net192));
 sky130_fd_sc_hd__clkbuf_2 max_cap194 (.A(net577),
    .X(net193));
 sky130_fd_sc_hd__clkbuf_2 max_cap195 (.A(net195),
    .X(net194));
 sky130_fd_sc_hd__clkbuf_2 max_cap196 (.A(net578),
    .X(net195));
 sky130_fd_sc_hd__clkbuf_1 max_cap197 (.A(\data_dout[57] ),
    .X(net196));
 sky130_fd_sc_hd__clkbuf_2 max_cap198 (.A(net580),
    .X(net197));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap203 (.A(net203),
    .X(net202));
 sky130_fd_sc_hd__clkbuf_1 max_cap204 (.A(net583),
    .X(net203));
 sky130_fd_sc_hd__clkbuf_2 max_cap205 (.A(\data_dout[53] ),
    .X(net204));
 sky130_fd_sc_hd__clkbuf_2 max_cap206 (.A(\data_dout[52] ),
    .X(net205));
 sky130_fd_sc_hd__clkbuf_2 max_cap207 (.A(net586),
    .X(net206));
 sky130_fd_sc_hd__clkbuf_2 max_cap208 (.A(net208),
    .X(net207));
 sky130_fd_sc_hd__clkbuf_1 max_cap209 (.A(net587),
    .X(net208));
 sky130_fd_sc_hd__clkbuf_2 max_cap210 (.A(net210),
    .X(net209));
 sky130_fd_sc_hd__clkbuf_2 max_cap211 (.A(\data_dout[4] ),
    .X(net210));
 sky130_fd_sc_hd__clkbuf_2 max_cap212 (.A(net589),
    .X(net211));
 sky130_fd_sc_hd__clkbuf_1 max_cap213 (.A(net590),
    .X(net212));
 sky130_fd_sc_hd__clkbuf_2 max_cap214 (.A(net214),
    .X(net213));
 sky130_fd_sc_hd__clkbuf_2 max_cap215 (.A(net591),
    .X(net214));
 sky130_fd_sc_hd__clkbuf_2 max_cap216 (.A(net592),
    .X(net215));
 sky130_fd_sc_hd__clkbuf_1 max_cap217 (.A(net594),
    .X(net216));
 sky130_fd_sc_hd__clkbuf_2 max_cap218 (.A(\data_dout[46] ),
    .X(net217));
 sky130_fd_sc_hd__clkbuf_1 max_cap219 (.A(net596),
    .X(net218));
 sky130_fd_sc_hd__clkbuf_2 max_cap220 (.A(net595),
    .X(net219));
 sky130_fd_sc_hd__clkbuf_1 max_cap221 (.A(net597),
    .X(net220));
 sky130_fd_sc_hd__clkbuf_2 max_cap222 (.A(net598),
    .X(net221));
 sky130_fd_sc_hd__dlymetal6s2s_1 max_cap223 (.A(net600),
    .X(net222));
 sky130_fd_sc_hd__clkbuf_2 max_cap224 (.A(net599),
    .X(net223));
 sky130_fd_sc_hd__clkbuf_2 max_cap225 (.A(net225),
    .X(net224));
 sky130_fd_sc_hd__clkbuf_2 max_cap226 (.A(\data_dout[42] ),
    .X(net225));
 sky130_fd_sc_hd__clkbuf_2 max_cap227 (.A(net227),
    .X(net226));
 sky130_fd_sc_hd__clkbuf_1 max_cap228 (.A(\data_dout[41] ),
    .X(net227));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap229 (.A(\data_dout[40] ),
    .X(net228));
 sky130_fd_sc_hd__clkbuf_2 max_cap230 (.A(net604),
    .X(net229));
 sky130_fd_sc_hd__clkbuf_2 max_cap231 (.A(net605),
    .X(net230));
 sky130_fd_sc_hd__clkbuf_2 max_cap232 (.A(net232),
    .X(net231));
 sky130_fd_sc_hd__clkbuf_2 max_cap233 (.A(net606),
    .X(net232));
 sky130_fd_sc_hd__clkbuf_2 max_cap234 (.A(net234),
    .X(net233));
 sky130_fd_sc_hd__clkbuf_2 max_cap235 (.A(net607),
    .X(net234));
 sky130_fd_sc_hd__clkbuf_1 max_cap236 (.A(net608),
    .X(net235));
 sky130_fd_sc_hd__clkbuf_2 max_cap237 (.A(net609),
    .X(net236));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap243 (.A(net243),
    .X(net242));
 sky130_fd_sc_hd__clkbuf_1 max_cap244 (.A(net613),
    .X(net243));
 ...
 sky130_fd_sc_hd__clkbuf_1 max_cap259 (.A(\data_dout[24] ),
    .X(net258));
 sky130_fd_sc_hd__clkbuf_2 max_cap260 (.A(net621),
    .X(net259));
 sky130_fd_sc_hd__clkbuf_2 max_cap261 (.A(net261),
    .X(net260));
 sky130_fd_sc_hd__clkbuf_1 max_cap262 (.A(net623),
    .X(net261));
 sky130_fd_sc_hd__clkbuf_2 max_cap263 (.A(net263),
    .X(net262));
 sky130_fd_sc_hd__clkbuf_1 max_cap264 (.A(net624),
    .X(net263));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap270 (.A(net270),
    .X(net269));
 sky130_fd_sc_hd__clkbuf_2 max_cap271 (.A(net628),
    .X(net270));
 sky130_fd_sc_hd__clkbuf_2 max_cap272 (.A(net272),
    .X(net271));
 sky130_fd_sc_hd__clkbuf_2 max_cap273 (.A(net629),
    .X(net272));
 sky130_fd_sc_hd__clkbuf_2 max_cap274 (.A(net630),
    .X(net273));
 sky130_fd_sc_hd__clkbuf_2 max_cap275 (.A(net275),
    .X(net274));
 sky130_fd_sc_hd__clkbuf_1 max_cap276 (.A(net631),
    .X(net275));
 sky130_fd_sc_hd__clkbuf_2 max_cap277 (.A(net632),
    .X(net276));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap282 (.A(net282),
    .X(net281));
 sky130_fd_sc_hd__clkbuf_2 max_cap283 (.A(net635),
    .X(net282));
 sky130_fd_sc_hd__clkbuf_2 max_cap284 (.A(net284),
    .X(net283));
 sky130_fd_sc_hd__clkbuf_2 max_cap285 (.A(\data_dout[10] ),
    .X(net284));
 sky130_fd_sc_hd__clkbuf_1 max_cap563 (.A(\ecc_dout[6] ),
    .X(net562));
 sky130_fd_sc_hd__clkbuf_1 max_cap564 (.A(\ecc_dout[5] ),
    .X(net563));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap565 (.A(\ecc_dout[4] ),
    .X(net564));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap566 (.A(\ecc_dout[3] ),
    .X(net565));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap567 (.A(\ecc_dout[2] ),
    .X(net566));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap568 (.A(\ecc_dout[1] ),
    .X(net567));
 sky130_fd_sc_hd__clkbuf_2 max_cap569 (.A(\ecc_dout[0] ),
    .X(net568));
 sky130_fd_sc_hd__clkbuf_1 max_cap570 (.A(\data_dout[9] ),
    .X(net569));
 sky130_fd_sc_hd__dlymetal6s2s_1 max_cap571 (.A(\data_dout[8] ),
    .X(net570));
 sky130_fd_sc_hd__clkbuf_1 max_cap572 (.A(\data_dout[6] ),
    .X(net571));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap573 (.A(\data_dout[62] ),
    .X(net572));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap574 (.A(\data_dout[61] ),
    .X(net573));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap575 (.A(\data_dout[60] ),
    .X(net574));
 sky130_fd_sc_hd__clkbuf_1 max_cap576 (.A(\data_dout[5] ),
    .X(net575));
 sky130_fd_sc_hd__clkbuf_2 max_cap577 (.A(net577),
    .X(net576));
 sky130_fd_sc_hd__clkbuf_2 max_cap578 (.A(\data_dout[59] ),
    .X(net577));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap579 (.A(\data_dout[58] ),
    .X(net578));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap580 (.A(net580),
    .X(net579));
 sky130_fd_sc_hd__clkbuf_1 max_cap581 (.A(\data_dout[57] ),
    .X(net580));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap582 (.A(\data_dout[56] ),
    .X(net581));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap583 (.A(\data_dout[55] ),
    .X(net582));
 sky130_fd_sc_hd__clkbuf_1 max_cap584 (.A(\data_dout[54] ),
    .X(net583));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap585 (.A(\data_dout[53] ),
    .X(net584));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap586 (.A(\data_dout[52] ),
    .X(net585));
 sky130_fd_sc_hd__clkbuf_2 max_cap587 (.A(\data_dout[51] ),
    .X(net586));
 sky130_fd_sc_hd__clkbuf_1 max_cap588 (.A(\data_dout[50] ),
    .X(net587));
 sky130_fd_sc_hd__clkbuf_1 max_cap589 (.A(\data_dout[4] ),
    .X(net588));
 sky130_fd_sc_hd__clkbuf_2 max_cap590 (.A(\data_dout[49] ),
    .X(net589));
 sky130_fd_sc_hd__clkbuf_2 max_cap591 (.A(\data_dout[49] ),
    .X(net590));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap592 (.A(\data_dout[48] ),
    .X(net591));
 sky130_fd_sc_hd__clkbuf_1 max_cap593 (.A(\data_dout[47] ),
    .X(net592));
 sky130_fd_sc_hd__clkbuf_1 max_cap594 (.A(net594),
    .X(net593));
 sky130_fd_sc_hd__dlymetal6s2s_1 max_cap595 (.A(\data_dout[46] ),
    .X(net594));
 sky130_fd_sc_hd__clkbuf_1 max_cap596 (.A(net596),
    .X(net595));
 sky130_fd_sc_hd__clkbuf_1 max_cap597 (.A(\data_dout[45] ),
    .X(net596));
 sky130_fd_sc_hd__clkbuf_2 max_cap598 (.A(net598),
    .X(net597));
 sky130_fd_sc_hd__clkbuf_2 max_cap599 (.A(\data_dout[44] ),
    .X(net598));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap600 (.A(net600),
    .X(net599));
 sky130_fd_sc_hd__clkbuf_1 max_cap601 (.A(\data_dout[43] ),
    .X(net600));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap602 (.A(\data_dout[42] ),
    .X(net601));
 sky130_fd_sc_hd__clkbuf_1 max_cap603 (.A(\data_dout[41] ),
    .X(net602));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap604 (.A(net604),
    .X(net603));
 sky130_fd_sc_hd__clkbuf_1 max_cap605 (.A(\data_dout[40] ),
    .X(net604));
 sky130_fd_sc_hd__clkbuf_1 max_cap606 (.A(\data_dout[39] ),
    .X(net605));
 sky130_fd_sc_hd__clkbuf_1 max_cap607 (.A(\data_dout[38] ),
    .X(net606));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap608 (.A(\data_dout[37] ),
    .X(net607));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap609 (.A(net609),
    .X(net608));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap610 (.A(\data_dout[36] ),
    .X(net609));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap611 (.A(\data_dout[35] ),
    .X(net610));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap612 (.A(\data_dout[34] ),
    .X(net611));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap613 (.A(\data_dout[33] ),
    .X(net612));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap614 (.A(\data_dout[32] ),
    .X(net613));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap615 (.A(\data_dout[30] ),
    .X(net614));
 sky130_fd_sc_hd__clkbuf_1 max_cap616 (.A(\data_dout[2] ),
    .X(net615));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap617 (.A(\data_dout[29] ),
    .X(net616));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap618 (.A(\data_dout[28] ),
    .X(net617));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap619 (.A(\data_dout[27] ),
    .X(net618));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap620 (.A(\data_dout[26] ),
    .X(net619));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap621 (.A(\data_dout[25] ),
    .X(net620));
 sky130_fd_sc_hd__clkbuf_1 max_cap622 (.A(net622),
    .X(net621));
 sky130_fd_sc_hd__clkbuf_2 max_cap623 (.A(\data_dout[24] ),
    .X(net622));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap624 (.A(\data_dout[23] ),
    .X(net623));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap625 (.A(\data_dout[22] ),
    .X(net624));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap626 (.A(\data_dout[21] ),
    .X(net625));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap627 (.A(\data_dout[20] ),
    .X(net626));
 sky130_fd_sc_hd__clkbuf_1 max_cap628 (.A(\data_dout[1] ),
    .X(net627));
 sky130_fd_sc_hd__clkbuf_1 max_cap629 (.A(\data_dout[19] ),
    .X(net628));
 sky130_fd_sc_hd__clkbuf_2 max_cap630 (.A(\data_dout[18] ),
    .X(net629));
 sky130_fd_sc_hd__clkbuf_1 max_cap631 (.A(\data_dout[17] ),
    .X(net630));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap632 (.A(\data_dout[16] ),
    .X(net631));
 sky130_fd_sc_hd__clkbuf_1 max_cap633 (.A(\data_dout[14] ),
    .X(net632));
 sky130_fd_sc_hd__clkbuf_1 max_cap634 (.A(\data_dout[13] ),
    .X(net633));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap635 (.A(\data_dout[12] ),
    .X(net634));
 sky130_fd_sc_hd__clkbuf_1 max_cap636 (.A(\data_dout[11] ),
    .X(net635));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap637 (.A(\data_dout[10] ),
    .X(net636));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output114 (.A(net653),
    .X(payload_out[28]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output118 (.A(net655),
    .X(payload_out[31]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output136 (.A(net654),
    .X(payload_out[48]));
 ...
 sky130_fd_sc_hd__buf_4 place462 (.A(net107),
    .X(payload_out[22]));
 sky130_fd_sc_hd__buf_4 place640 (.A(net147),
    .X(payload_out[59]));
 sky130_fd_sc_hd__buf_4 place641 (.A(net111),
    .X(payload_out[26]));
 sky130_fd_sc_hd__buf_4 place642 (.A(net108),
    .X(payload_out[23]));
 sky130_fd_sc_hd__buf_4 place643 (.A(net103),
    .X(payload_out[19]));
 sky130_fd_sc_hd__buf_4 place644 (.A(net152),
    .X(payload_out[63]));
 sky130_fd_sc_hd__buf_4 place645 (.A(net151),
    .X(payload_out[62]));
 sky130_fd_sc_hd__buf_4 place646 (.A(net149),
    .X(payload_out[60]));
 sky130_fd_sc_hd__buf_4 place647 (.A(net126),
    .X(payload_out[3]));
 sky130_fd_sc_hd__buf_4 place648 (.A(net118),
    .X(payload_out[32]));
 sky130_fd_sc_hd__buf_4 place649 (.A(net116),
    .X(payload_out[30]));
 sky130_fd_sc_hd__buf_4 place650 (.A(net115),
    .X(payload_out[2]));
 sky130_fd_sc_hd__buf_4 place651 (.A(net112),
    .X(payload_out[27]));
 sky130_fd_sc_hd__buf_4 place652 (.A(net110),
    .X(payload_out[25]));
 sky130_fd_sc_hd__buf_4 place653 (.A(net109),
    .X(payload_out[24]));
 sky130_fd_sc_hd__buf_4 place654 (.A(net113),
    .X(net653));
 sky130_fd_sc_hd__buf_4 place655 (.A(net135),
    .X(net654));
 sky130_fd_sc_hd__buf_4 place656 (.A(net117),
    .X(net655));
 sky130_fd_sc_hd__buf_4 place657 (.A(\encoded_word[71] ),
    .X(net656));
 sky130_fd_sc_hd__buf_4 place658 (.A(_145_),
    .X(net657));
 ...
 sky130_fd_sc_hd__buf_4 place662 (.A(_203_),
    .X(net661));
 sky130_fd_sc_hd__buf_4 place663 (.A(_188_),
    .X(net662));
 sky130_fd_sc_hd__buf_4 place664 (.A(_174_),
    .X(net663));
 sky130_fd_sc_hd__buf_4 place665 (.A(_163_),
    .X(net664));
 sky130_fd_sc_hd__buf_4 place666 (.A(_155_),
    .X(net665));
 sky130_fd_sc_hd__buf_4 place667 (.A(_099_),
    .X(net666));
 sky130_fd_sc_hd__buf_4 place668 (.A(_192_),
    .X(net667));
 sky130_fd_sc_hd__buf_4 place669 (.A(_168_),
    .X(net668));
 sky130_fd_sc_hd__buf_4 place670 (.A(_159_),
    .X(net669));
 sky130_fd_sc_hd__buf_4 place671 (.A(_124_),
    .X(net670));
 sky130_fd_sc_hd__buf_4 place672 (.A(_104_),
    .X(net671));
 sky130_fd_sc_hd__buf_4 place673 (.A(\encoded_word[1] ),
    .X(net672));
 sky130_fd_sc_hd__buf_4 place674 (.A(\encoded_word[0] ),
    .X(net673));
 sky130_fd_sc_hd__buf_4 place675 (.A(\encoded_word[3] ),
    .X(net674));
 sky130_fd_sc_hd__buf_4 place676 (.A(\encoded_word[7] ),
    .X(net675));
 sky130_fd_sc_hd__buf_4 place677 (.A(\encoded_word[15] ),
    .X(net676));
 sky130_fd_sc_hd__buf_4 place678 (.A(_143_),
    .X(net677));
 sky130_fd_sc_hd__buf_4 place679 (.A(_139_),
    .X(net678));
 sky130_fd_sc_hd__buf_4 place680 (.A(_097_),
    .X(net679));
 sky130_fd_sc_hd__buf_4 place681 (.A(_084_),
    .X(net680));
 sky130_fd_sc_hd__buf_4 place682 (.A(_274_),
    .X(net681));
 sky130_fd_sc_hd__buf_4 place683 (.A(_266_),
    .X(net682));
 sky130_fd_sc_hd__buf_4 place684 (.A(_110_),
    .X(net683));
 sky130_fd_sc_hd__buf_4 place685 (.A(_077_),
    .X(net684));
 sky130_fd_sc_hd__buf_4 place686 (.A(_044_),
    .X(net685));
 sky130_fd_sc_hd__buf_4 place687 (.A(_024_),
    .X(net686));
 sky130_fd_sc_hd__buf_4 place688 (.A(_372_),
    .X(net687));
 sky130_fd_sc_hd__buf_4 place689 (.A(_273_),
    .X(net688));
 sky130_fd_sc_hd__buf_4 place690 (.A(\encoded_word[63] ),
    .X(net689));
 ...
 sky130_fd_sc_hd__buf_4 place693 (.A(_063_),
    .X(net692));
 sky130_fd_sc_hd__buf_4 place694 (.A(_045_),
    .X(net693));
 sky130_fd_sc_hd__buf_4 place695 (.A(_018_),
    .X(net694));
 sky130_fd_sc_hd__buf_4 place696 (.A(_353_),
    .X(net695));
 sky130_fd_sc_hd__buf_4 place697 (.A(_352_),
    .X(net696));
 sky130_fd_sc_hd__buf_4 place698 (.A(_328_),
    .X(net697));
 sky130_fd_sc_hd__buf_4 place699 (.A(_324_),
    .X(net698));
 sky130_fd_sc_hd__buf_4 place700 (.A(net90),
    .X(net699));
 sky130_fd_sc_hd__buf_4 place701 (.A(net88),
    .X(net700));
 sky130_fd_sc_hd__buf_4 place702 (.A(net87),
    .X(net701));
 sky130_fd_sc_hd__buf_4 place703 (.A(net86),
    .X(net702));
 sky130_fd_sc_hd__buf_4 place704 (.A(net85),
    .X(net703));
 sky130_fd_sc_hd__buf_4 place705 (.A(net84),
    .X(net704));
 sky130_fd_sc_hd__buf_4 place706 (.A(net83),
    .X(net705));
 sky130_fd_sc_hd__buf_4 place707 (.A(net82),
    .X(net706));
 sky130_fd_sc_hd__buf_4 place708 (.A(net81),
    .X(net707));
 sky130_fd_sc_hd__buf_4 place709 (.A(net80),
    .X(net708));
 sky130_fd_sc_hd__buf_4 place710 (.A(net79),
    .X(net709));
 sky130_fd_sc_hd__buf_4 place711 (.A(net78),
    .X(net710));
 sky130_fd_sc_hd__buf_4 place712 (.A(net77),
    .X(net711));
 sky130_fd_sc_hd__buf_4 place713 (.A(net76),
    .X(net712));
 sky130_fd_sc_hd__buf_4 place714 (.A(net75),
    .X(net713));
 sky130_fd_sc_hd__buf_4 place715 (.A(net715),
    .X(net714));
 sky130_fd_sc_hd__buf_4 place716 (.A(net74),
    .X(net715));
 sky130_fd_sc_hd__buf_4 place717 (.A(net73),
    .X(net716));
 sky130_fd_sc_hd__buf_4 place718 (.A(net718),
    .X(net717));
 sky130_fd_sc_hd__buf_4 place719 (.A(net72),
    .X(net718));
 sky130_fd_sc_hd__buf_4 place720 (.A(net71),
    .X(net719));
 sky130_fd_sc_hd__buf_4 place721 (.A(net70),
    .X(net720));
 sky130_fd_sc_hd__buf_4 place722 (.A(net69),
    .X(net721));
 sky130_fd_sc_hd__buf_4 place723 (.A(net68),
    .X(net722));
 sky130_fd_sc_hd__buf_4 place724 (.A(net67),
    .X(net723));
 sky130_fd_sc_hd__buf_4 place725 (.A(net66),
    .X(net724));
 sky130_fd_sc_hd__buf_4 place726 (.A(net726),
    .X(net725));
 sky130_fd_sc_hd__buf_4 place727 (.A(net65),
    .X(net726));
 sky130_fd_sc_hd__buf_4 place728 (.A(net64),
    .X(net727));
 sky130_fd_sc_hd__buf_4 place729 (.A(net63),
    .X(net728));
 sky130_fd_sc_hd__buf_4 place730 (.A(net62),
    .X(net729));
 sky130_fd_sc_hd__buf_4 place731 (.A(net61),
    .X(net730));
 sky130_fd_sc_hd__buf_4 place732 (.A(net60),
    .X(net731));
 sky130_fd_sc_hd__buf_4 place733 (.A(net59),
    .X(net732));
 sky130_fd_sc_hd__buf_4 place734 (.A(net58),
    .X(net733));
 sky130_fd_sc_hd__buf_4 place735 (.A(net57),
    .X(net734));
 sky130_fd_sc_hd__buf_4 place736 (.A(net56),
    .X(net735));
 sky130_fd_sc_hd__buf_4 place737 (.A(net55),
    .X(net736));
 sky130_fd_sc_hd__buf_4 place738 (.A(net54),
    .X(net737));
 sky130_fd_sc_hd__buf_4 place739 (.A(net53),
    .X(net738));
 sky130_fd_sc_hd__buf_4 place740 (.A(net52),
    .X(net739));
 sky130_fd_sc_hd__buf_4 place741 (.A(net51),
    .X(net740));
 sky130_fd_sc_hd__buf_4 place742 (.A(net50),
    .X(net741));
 sky130_fd_sc_hd__buf_4 place743 (.A(net49),
    .X(net742));
 sky130_fd_sc_hd__buf_4 place744 (.A(net48),
    .X(net743));
 sky130_fd_sc_hd__buf_4 place745 (.A(net47),
    .X(net744));
 sky130_fd_sc_hd__buf_4 place746 (.A(net46),
    .X(net745));
 sky130_fd_sc_hd__buf_4 place747 (.A(net45),
    .X(net746));
 sky130_fd_sc_hd__buf_4 place748 (.A(net44),
    .X(net747));
 sky130_fd_sc_hd__buf_4 place749 (.A(net43),
    .X(net748));
 sky130_fd_sc_hd__buf_4 place750 (.A(net42),
    .X(net749));
 sky130_fd_sc_hd__buf_4 place751 (.A(net41),
    .X(net750));
 sky130_fd_sc_hd__buf_4 place752 (.A(net40),
    .X(net751));
 sky130_fd_sc_hd__buf_4 place753 (.A(net39),
    .X(net752));
 sky130_fd_sc_hd__buf_4 place754 (.A(net38),
    .X(net753));
 sky130_fd_sc_hd__buf_4 place755 (.A(net37),
    .X(net754));
 sky130_fd_sc_hd__buf_4 place756 (.A(net36),
    .X(net755));
 sky130_fd_sc_hd__buf_4 place757 (.A(net35),
    .X(net756));
 sky130_fd_sc_hd__buf_4 place758 (.A(net34),
    .X(net757));
 sky130_fd_sc_hd__buf_4 place759 (.A(net33),
    .X(net758));
 sky130_fd_sc_hd__buf_4 place760 (.A(net32),
    .X(net759));
 sky130_fd_sc_hd__buf_4 place761 (.A(net31),
    .X(net760));
 sky130_fd_sc_hd__buf_4 place762 (.A(net30),
    .X(net761));
 sky130_fd_sc_hd__buf_4 place763 (.A(net29),
    .X(net762));
 sky130_fd_sc_hd__buf_4 place764 (.A(net28),
    .X(net763));
 sky130_fd_sc_hd__buf_4 place765 (.A(net27),
    .X(net764));
 sky130_fd_sc_hd__buf_4 place766 (.A(net26),
    .X(net765));
 sky130_fd_sc_hd__buf_4 place767 (.A(net25),
    .X(net766));
 sky130_fd_sc_hd__buf_4 place768 (.A(net24),
    .X(net767));
 sky130_fd_sc_hd__buf_4 place769 (.A(net23),
    .X(net768));
 sky130_fd_sc_hd__buf_4 place770 (.A(net22),
    .X(net769));
 sky130_fd_sc_hd__buf_4 place771 (.A(net21),
    .X(net770));
 sky130_fd_sc_hd__buf_4 place772 (.A(net20),
    .X(net771));
 sky130_fd_sc_hd__buf_4 place773 (.A(net19),
    .X(net772));
 sky130_fd_sc_hd__buf_4 place774 (.A(net18),
    .X(net773));
 sky130_fd_sc_hd__buf_4 place775 (.A(net17),
    .X(net774));
 sky130_fd_sc_hd__buf_4 place776 (.A(net16),
    .X(net775));
 sram22_256x64m4w8 u_data (.we(net699),
    .ce(net767),
 ...
 sram22_256x8m8w1 u_ecc0 (.we(net699),
    .ce(net767),
 ...
 sky130_fd_sc_hd__buf_16 wire289 (.A(net783),
    .X(net288));
 sky130_fd_sc_hd__buf_16 wire290 (.A(net783),
    .X(net289));
 sky130_fd_sc_hd__buf_16 wire638 (.A(net778),
    .X(net637));
 sky130_fd_sc_hd__buf_16 wire639 (.A(net784),
    .X(net638));
endmodule
