...
source /campaign-run/power_explicit_activity/remediation03/IDLE/routed_net_activity.tcl
report_activity_annotation > /campaign-run/power_explicit_activity/remediation03/IDLE/annotation.rpt
report_activity_annotation -report_annotated > /campaign-run/power_explicit_activity/remediation03/IDLE/annotated.rpt
report_activity_annotation -report_unannotated > /campaign-run/power_explicit_activity/remediation03/IDLE/unannotated.rpt
report_power -digits 12 > /campaign-run/power_explicit_activity/remediation03/IDLE/power.rpt
report_power -format json > /campaign-run/power_explicit_activity/remediation03/IDLE/power.json
report_power -instances [get_cells {u_data u_ecc0}] -digits 12 > /campaign-run/power_explicit_activity/remediation03/IDLE/macros.power.rpt
