...
source /campaign-run/power_explicit_activity/remediation02/IDLE/routed_net_activity.tcl
report_activity_annotation > /campaign-run/power_explicit_activity/remediation02/IDLE/annotation.rpt
report_activity_annotation -report_annotated > /campaign-run/power_explicit_activity/remediation02/IDLE/annotated.rpt
report_activity_annotation -report_unannotated > /campaign-run/power_explicit_activity/remediation02/IDLE/unannotated.rpt
report_power -digits 12 > /campaign-run/power_explicit_activity/remediation02/IDLE/power.rpt
report_power -format json > /campaign-run/power_explicit_activity/remediation02/IDLE/power.json
report_power -instances [get_cells {u_data u_ecc0}] -digits 12 > /campaign-run/power_explicit_activity/remediation02/IDLE/macros.power.rpt
puts "GREEN_V33_POWER_COMPLETE architecture=hsiao_matched_sram_top operation=IDLE"
