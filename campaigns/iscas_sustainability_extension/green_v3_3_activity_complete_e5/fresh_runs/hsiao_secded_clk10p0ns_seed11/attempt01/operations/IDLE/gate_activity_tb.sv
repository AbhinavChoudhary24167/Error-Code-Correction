...
module tb;
  ...
  initial begin
    ...
    $readmemh("/mnt/c/Users/Abhinav/OneDrive/Desktop/ECC/Error-Code-Correction/campaigns/iscas_sustainability_extension/green_v3_3_activity_complete_e5/fresh_runs/hsiao_secded_clk10p0ns_seed11/attempt01/workloads/codewords_idle.hex", codewords);
    ...
    $dumpfile("/var/lib/green-ecc-v33-activity-complete-e5/fresh_runs/hsiao_secded_clk10p0ns_seed11/attempt01/activity/IDLE.vcd");
    $dumpvars(1, dut);
