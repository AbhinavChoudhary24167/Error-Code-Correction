...
source /campaign-run/power_explicit_activity/remediation06/READ_SINGLE_BIT_ERROR_CORRECT/routed_net_activity.tcl
puts "GREEN_V33_MACRO_OUTPUT_ACTIVITY_ROOT_ANNOTATIONS count=$green_v33_activity_root_annotation_count"
report_activity_annotation > /campaign-run/power_explicit_activity/remediation06/READ_SINGLE_BIT_ERROR_CORRECT/annotation.rpt
report_activity_annotation -report_annotated > /campaign-run/power_explicit_activity/remediation06/READ_SINGLE_BIT_ERROR_CORRECT/annotated.rpt
report_activity_annotation -report_unannotated > /campaign-run/power_explicit_activity/remediation06/READ_SINGLE_BIT_ERROR_CORRECT/unannotated.rpt
report_power -digits 12 > /campaign-run/power_explicit_activity/remediation06/READ_SINGLE_BIT_ERROR_CORRECT/power.rpt
report_power -format json > /campaign-run/power_explicit_activity/remediation06/READ_SINGLE_BIT_ERROR_CORRECT/power.json
report_power -instances [get_cells {u_data u_ecc0}] -digits 12 > /campaign-run/power_explicit_activity/remediation06/READ_SINGLE_BIT_ERROR_CORRECT/macros.power.rpt
