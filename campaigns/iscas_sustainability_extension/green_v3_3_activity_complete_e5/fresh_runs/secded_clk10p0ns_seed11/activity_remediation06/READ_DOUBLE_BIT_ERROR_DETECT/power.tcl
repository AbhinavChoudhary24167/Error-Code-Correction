...
source /campaign-run/power_explicit_activity/remediation06/READ_DOUBLE_BIT_ERROR_DETECT/routed_net_activity.tcl
puts "GREEN_V33_MACRO_OUTPUT_ACTIVITY_ROOT_ANNOTATIONS count=$green_v33_activity_root_annotation_count"
report_activity_annotation > /campaign-run/power_explicit_activity/remediation06/READ_DOUBLE_BIT_ERROR_DETECT/annotation.rpt
report_activity_annotation -report_annotated > /campaign-run/power_explicit_activity/remediation06/READ_DOUBLE_BIT_ERROR_DETECT/annotated.rpt
report_activity_annotation -report_unannotated > /campaign-run/power_explicit_activity/remediation06/READ_DOUBLE_BIT_ERROR_DETECT/unannotated.rpt
report_power -digits 12 > /campaign-run/power_explicit_activity/remediation06/READ_DOUBLE_BIT_ERROR_DETECT/power.rpt
report_power -format json > /campaign-run/power_explicit_activity/remediation06/READ_DOUBLE_BIT_ERROR_DETECT/power.json
report_power -instances [get_cells {u_data u_ecc0}] -digits 12 > /campaign-run/power_explicit_activity/remediation06/READ_DOUBLE_BIT_ERROR_DETECT/macros.power.rpt
