module secded_matched_sram_top (ce,
 ...
 sky130_fd_sc_hd__xnor2_1 _398_ (.A(\data_dout[58] ),
    .B(\data_dout[59] ),
    .Y(_005_));
 sky130_fd_sc_hd__xnor2_1 _399_ (.A(net577),
    .B(\data_dout[57] ),
    .Y(_006_));
 ...
 sky130_fd_sc_hd__xnor2_1 _404_ (.A(_009_),
    .B(_010_),
    .Y(_011_));
 sky130_fd_sc_hd__xor2_1 _405_ (.A(net604),
    .B(net606),
    .X(_012_));
 sky130_fd_sc_hd__xnor2_1 _406_ (.A(net603),
    .B(net589),
    .Y(_013_));
 ...
 sky130_fd_sc_hd__xnor3_2 _410_ (.A(\data_dout[62] ),
    ...
    .C(net581),
    .X(_017_));
 sky130_fd_sc_hd__xnor2_1 _411_ (.A(net569),
    .B(net580),
    .Y(_018_));
 ...
 sky130_fd_sc_hd__xnor3_1 _421_ (.A(_025_),
    ...
    .C(_027_),
    .X(_028_));
 sky130_fd_sc_hd__xnor2_1 _422_ (.A(net622),
    .B(net265),
    .Y(_029_));
 ...
 sky130_fd_sc_hd__xnor2_2 _424_ (.A(_028_),
    .B(_030_),
    .Y(_031_));
 sky130_fd_sc_hd__xnor2_1 _425_ (.A(net610),
    .B(net257),
    .Y(_032_));
 sky130_fd_sc_hd__xnor2_1 _426_ (.A(net612),
    .B(net255),
    .Y(_033_));
 ...
 sky130_fd_sc_hd__xor2_1 _437_ (.A(_041_),
    .B(_043_),
    .X(_044_));
 sky130_fd_sc_hd__xnor2_2 _438_ (.A(net584),
    .B(\data_dout[3] ),
    .Y(_045_));
 sky130_fd_sc_hd__xnor2_1 _439_ (.A(net571),
    .B(net234),
    .Y(_046_));
 ...
 sky130_fd_sc_hd__xnor3_2 _444_ (.A(_019_),
    ...
    .C(_050_),
    .X(_051_));
 sky130_fd_sc_hd__xor2_1 _445_ (.A(net681),
    .B(_051_),
    .X(_052_));
 sky130_fd_sc_hd__xor2_1 _446_ (.A(net621),
    .B(net170),
    .X(_053_));
 ...
 sky130_fd_sc_hd__xnor2_1 _456_ (.A(net247),
    .B(net177),
    .Y(_063_));
 sky130_fd_sc_hd__xnor2_1 _457_ (.A(net689),
    .B(net688),
    .Y(_064_));
 ...
 sky130_fd_sc_hd__xnor2_1 _470_ (.A(_073_),
    .B(_076_),
    .Y(_077_));
 sky130_fd_sc_hd__xor2_2 _471_ (.A(net629),
    .B(net565),
    .X(_078_));
 ...
 sky130_fd_sc_hd__nand3_2 _475_ (.A(_052_),
    ...
    .C(_081_),
    .Y(_082_));
 sky130_fd_sc_hd__xnor2_2 _476_ (.A(net681),
    .B(_051_),
    .Y(_083_));
 ...
 sky130_fd_sc_hd__xnor2_1 _481_ (.A(_078_),
    .B(net687),
    .Y(_088_));
 sky130_fd_sc_hd__xnor3_1 _482_ (.A(net630),
    .B(net632),
    .C(\data_dout[8] ),
    .X(_089_));
 ...
 sky130_fd_sc_hd__xor2_1 _486_ (.A(net186),
    .B(net190),
    .X(_093_));
 sky130_fd_sc_hd__xnor2_1 _487_ (.A(net578),
    .B(net188),
    .Y(_094_));
 ...
 sky130_fd_sc_hd__a21oi_2 _491_ (.A1(_082_),
    ...
    .B1(_097_),
    .Y(_098_));
 sky130_fd_sc_hd__mux2i_1 _492_ (.A0(net682),
    .A1(_037_),
    .S(_098_),
    .Y(_099_));
 sky130_fd_sc_hd__xor2_4 _493_ (.A(net676),
    .B(net663),
    .X(_100_));
 ...
 sky130_fd_sc_hd__nand3_1 _496_ (.A(_083_),
    ...
    .C(_081_),
    .Y(_103_));
 sky130_fd_sc_hd__o21ai_1 _497_ (.A1(net675),
    .A2(_102_),
    .B1(_103_),
    .Y(_104_));
 ...
 sky130_fd_sc_hd__xnor2_2 _503_ (.A(_107_),
    .B(_109_),
    .Y(_110_));
 sky130_fd_sc_hd__nand3b_1 _505_ (.A_N(net682),
    .B(_037_),
    .C(_016_),
    .Y(_112_));
 ...
 sky130_fd_sc_hd__xor2_1 _509_ (.A(\data_dout[2] ),
    .B(\data_dout[0] ),
    .X(_116_));
 sky130_fd_sc_hd__xnor2_1 _510_ (.A(net623),
    .B(\ecc_dout[7] ),
    .Y(_117_));
 sky130_fd_sc_hd__xnor2_1 _511_ (.A(net686),
    .B(net685),
    .Y(_118_));
 ...
 sky130_fd_sc_hd__xnor2_1 _514_ (.A(_011_),
    .B(_047_),
    .Y(_121_));
 sky130_fd_sc_hd__xnor2_1 _515_ (.A(net682),
    .B(_121_),
    .Y(_122_));
 ...
 sky130_fd_sc_hd__xnor2_2 _517_ (.A(_092_),
    .B(_123_),
    .Y(_124_));
 sky130_fd_sc_hd__o21a_1 _518_ (.A1(net679),
    .A2(_115_),
    .B1(net666),
    .X(net91));
 ...
 sky130_fd_sc_hd__xnor2_1 _529_ (.A(net235),
    .B(net258),
    .Y(_135_));
 sky130_fd_sc_hd__xnor2_1 _530_ (.A(net686),
    .B(_135_),
    .Y(_136_));
 ...
 sky130_fd_sc_hd__xnor2_1 _533_ (.A(_128_),
    .B(_138_),
    .Y(_139_));
 sky130_fd_sc_hd__nand2b_1 _534_ (.A_N(net674),
    .B(net673),
    .Y(_140_));
 ...
 sky130_fd_sc_hd__nor2b_1 _539_ (.A(_140_),
    .B_N(_144_),
    .Y(_145_));
 sky130_fd_sc_hd__nand3_1 _540_ (.A(net656),
    .B(_126_),
    .C(_145_),
    .Y(_146_));
 sky130_fd_sc_hd__xnor2_1 _541_ (.A(net207),
    .B(_146_),
    .Y(net131));
 sky130_fd_sc_hd__nand2_1 _542_ (.A(net674),
    .B(net673),
    .Y(_147_));
 sky130_fd_sc_hd__nor2_1 _543_ (.A(net672),
    .B(_147_),
    .Y(_148_));
 sky130_fd_sc_hd__and2b_1 _544_ (.A_N(_141_),
    .B(net91),
    .X(_149_));
 sky130_fd_sc_hd__nand3_1 _546_ (.A(net656),
    .B(_148_),
    .C(_149_),
    .Y(_151_));
 ...
 sky130_fd_sc_hd__or2b_1 _549_ (.A(_141_),
    .B_N(_115_),
    .X(_153_));
 sky130_fd_sc_hd__xnor2_1 _550_ (.A(net679),
    .B(_153_),
    .Y(_154_));
 ...
 sky130_fd_sc_hd__o21ai_0 _556_ (.A1(_061_),
    ...
    .B1(_158_),
    .Y(_159_));
 sky130_fd_sc_hd__and3_1 _557_ (.A(net679),
    .B(net666),
    .C(_159_),
    .X(_160_));
 sky130_fd_sc_hd__xnor2_1 _559_ (.A(net676),
    .B(net682),
    .Y(_162_));
 sky130_fd_sc_hd__nor3_1 _560_ (.A(net672),
    .B(_147_),
    .C(_162_),
    .Y(_163_));
 ...
 sky130_fd_sc_hd__and3_1 _564_ (.A(_115_),
    ...
    .C(_165_),
    .X(_166_));
 sky130_fd_sc_hd__nor3_1 _566_ (.A(net674),
    .B(net673),
    .C(net672),
    .Y(_168_));
 sky130_fd_sc_hd__and3_1 _567_ (.A(_104_),
    ...
    .C(net665),
    .X(_169_));
 sky130_fd_sc_hd__xor2_1 _568_ (.A(net563),
    .B(_169_),
    .X(net146));
 ...
 sky130_fd_sc_hd__xnor2_2 _579_ (.A(net236),
    .B(_178_),
    .Y(net116));
 sky130_fd_sc_hd__xor2_1 _581_ (.A(net679),
    .B(_115_),
    .X(_180_));
 ...
 sky130_fd_sc_hd__xnor2_1 _585_ (.A(net259),
    .B(_183_),
    .Y(net103));
 sky130_fd_sc_hd__nand3_1 _586_ (.A(net656),
    .B(_176_),
    .C(_182_),
    .Y(_184_));
 ...
 sky130_fd_sc_hd__nand2_1 _588_ (.A(_083_),
    .B(_085_),
    .Y(_185_));
 sky130_fd_sc_hd__nand2_1 _589_ (.A(net675),
    .B(_081_),
    .Y(_186_));
 sky130_fd_sc_hd__o22ai_1 _590_ (.A1(net675),
    .A2(_185_),
    .B1(_186_),
    .B2(_083_),
    .Y(_187_));
 sky130_fd_sc_hd__and3_1 _591_ (.A(net679),
    .B(net666),
    .C(_187_),
    .X(_188_));
 sky130_fd_sc_hd__nand3b_1 _593_ (.A_N(net656),
    .B(_145_),
    .C(net659),
    .Y(_190_));
 sky130_fd_sc_hd__xnor2_1 _594_ (.A(net262),
    .B(_190_),
    .Y(net101));
 sky130_fd_sc_hd__nor3_1 _596_ (.A(net674),
    .B(net673),
    .C(_170_),
    .Y(_192_));
 sky130_fd_sc_hd__and2_1 _597_ (.A(_112_),
    .B(_114_),
    .X(_193_));
 sky130_fd_sc_hd__xnor2_1 _598_ (.A(net679),
    .B(_193_),
    .Y(_194_));
 sky130_fd_sc_hd__nand4_1 _599_ (.A(net656),
    .B(_149_),
    .C(net664),
    .D(_194_),
    .Y(_195_));
 sky130_fd_sc_hd__xnor2_1 _600_ (.A(net215),
    .B(_195_),
    .Y(net128));
 sky130_fd_sc_hd__and2_2 _601_ (.A(net665),
    .B(_187_),
    .X(_196_));
 ...
 sky130_fd_sc_hd__xnor2_1 _603_ (.A(net233),
    .B(_197_),
    .Y(net117));
 sky130_fd_sc_hd__and3_1 _604_ (.A(net679),
    .B(_104_),
    .C(net666),
    .X(_198_));
 sky130_fd_sc_hd__nand2_1 _606_ (.A(net661),
    .B(_198_),
    .Y(_200_));
 sky130_fd_sc_hd__xnor2_1 _607_ (.A(net283),
    .B(_200_),
    .Y(net153));
 sky130_fd_sc_hd__and2_2 _608_ (.A(net662),
    .B(_187_),
    .X(_201_));
 ...
 sky130_fd_sc_hd__xnor2_1 _610_ (.A(net231),
    .B(_202_),
    .Y(net118));
 sky130_fd_sc_hd__nor2_1 _611_ (.A(net672),
    .B(_173_),
    .Y(_203_));
 sky130_fd_sc_hd__nand2_1 _612_ (.A(net659),
    .B(net658),
    .Y(_204_));
 ...
 sky130_fd_sc_hd__xnor2_1 _616_ (.A(net174),
    .B(_206_),
    .Y(net147));
 sky130_fd_sc_hd__nand3_1 _617_ (.A(net662),
    .B(_159_),
    .C(_166_),
    .Y(_207_));
 sky130_fd_sc_hd__xnor2_1 _618_ (.A(net560),
    .B(_207_),
    .Y(net150));
 sky130_fd_sc_hd__nand2b_1 _619_ (.A_N(_193_),
    .B(net679),
    .Y(_208_));
 sky130_fd_sc_hd__nand4b_1 _620_ (.A_N(net656),
    .B(net662),
    .C(_181_),
    .D(_208_),
    .Y(_209_));
 ...
 sky130_fd_sc_hd__nor2_1 _622_ (.A(_170_),
    .B(_173_),
    .Y(_210_));
 sky130_fd_sc_hd__nand3_1 _623_ (.A(net656),
    .B(_149_),
    .C(_210_),
    .Y(_211_));
 ...
 sky130_fd_sc_hd__xnor2_1 _626_ (.A(net182),
    .B(_212_),
    .Y(net126));
 sky130_fd_sc_hd__nand4_1 _627_ (.A(net656),
    .B(net679),
    .C(_149_),
    .D(net658),
    .Y(_213_));
 sky130_fd_sc_hd__xnor2_1 _628_ (.A(net230),
    .B(_213_),
    .Y(net119));
 sky130_fd_sc_hd__nand3_1 _629_ (.A(net656),
    .B(_176_),
    .C(net664),
    .Y(_214_));
 sky130_fd_sc_hd__xnor2_1 _630_ (.A(net206),
    .B(_214_),
    .Y(net132));
 sky130_fd_sc_hd__nand3_1 _631_ (.A(net656),
    .B(_126_),
    .C(_210_),
    .Y(_215_));
 ...
 sky130_fd_sc_hd__nand2_1 _633_ (.A(_166_),
    .B(_196_),
    .Y(_216_));
 sky130_fd_sc_hd__xnor2_1 _634_ (.A(net559),
    .B(_216_),
    .Y(net151));
 ...
 sky130_fd_sc_hd__xnor2_2 _638_ (.A(net202),
    .B(_218_),
    .Y(net135));
 sky130_fd_sc_hd__nand4_1 _639_ (.A(net656),
    .B(net662),
    .C(_181_),
    .D(_208_),
    .Y(_219_));
 ...
 sky130_fd_sc_hd__xnor2_1 _642_ (.A(net254),
    .B(_220_),
    .Y(net106));
 sky130_fd_sc_hd__nand3_1 _643_ (.A(_159_),
    .B(_166_),
    .C(net665),
    .Y(_221_));
 ...
 sky130_fd_sc_hd__and2_1 _648_ (.A(net91),
    .B(_187_),
    .X(_224_));
 sky130_fd_sc_hd__nand3_1 _649_ (.A(net656),
    .B(_148_),
    .C(_224_),
    .Y(_225_));
 ...
 sky130_fd_sc_hd__xnor2_1 _652_ (.A(net244),
    .B(_226_),
    .Y(net110));
 sky130_fd_sc_hd__nand3_1 _653_ (.A(net656),
    .B(_182_),
    .C(net659),
    .Y(_227_));
 sky130_fd_sc_hd__xnor2_1 _654_ (.A(net184),
    .B(_227_),
    .Y(net144));
 sky130_fd_sc_hd__nor2_1 _655_ (.A(net674),
    .B(net673),
    .Y(_228_));
 ...
 sky130_fd_sc_hd__xnor2_1 _658_ (.A(net264),
    .B(_230_),
    .Y(net100));
 sky130_fd_sc_hd__nand3_1 _659_ (.A(net656),
    .B(net665),
    .C(_176_),
    .Y(_231_));
 sky130_fd_sc_hd__xnor2_1 _660_ (.A(net237),
    .B(_231_),
    .Y(net114));
 sky130_fd_sc_hd__nand3_1 _661_ (.A(net656),
    .B(_210_),
    .C(_224_),
    .Y(_232_));
 ...
 sky130_fd_sc_hd__xnor2_1 _664_ (.A(net260),
    .B(_233_),
    .Y(net102));
 sky130_fd_sc_hd__nand3_1 _665_ (.A(net656),
    .B(net659),
    .C(net658),
    .Y(_234_));
 ...
 sky130_fd_sc_hd__xnor2_1 _669_ (.A(net266),
    .B(_236_),
    .Y(net99));
 sky130_fd_sc_hd__nand3_1 _670_ (.A(net656),
    .B(_176_),
    .C(net658),
    .Y(_237_));
 sky130_fd_sc_hd__xnor2_1 _671_ (.A(net223),
    .B(_237_),
    .Y(net123));
 sky130_fd_sc_hd__nand3_1 _672_ (.A(net656),
    .B(_149_),
    .C(_235_),
    .Y(_238_));
 sky130_fd_sc_hd__xnor2_1 _673_ (.A(net213),
    .B(_238_),
    .Y(net129));
 sky130_fd_sc_hd__nand3_1 _674_ (.A(net656),
    .B(_126_),
    .C(net658),
    .Y(_239_));
 ...
 sky130_fd_sc_hd__xnor2_1 _681_ (.A(net273),
    .B(_242_),
    .Y(net96));
 sky130_fd_sc_hd__nand3_1 _682_ (.A(net656),
    .B(_160_),
    .C(_235_),
    .Y(_243_));
 sky130_fd_sc_hd__xnor2_1 _683_ (.A(net205),
    .B(_243_),
    .Y(net133));
 sky130_fd_sc_hd__nand2_1 _684_ (.A(net661),
    .B(_224_),
    .Y(_244_));
 sky130_fd_sc_hd__xnor2_1 _685_ (.A(net276),
    .B(_244_),
    .Y(net94));
 sky130_fd_sc_hd__nand3b_1 _686_ (.A_N(net656),
    .B(_160_),
    .C(net664),
    .Y(_245_));
 sky130_fd_sc_hd__xnor2_1 _687_ (.A(net269),
    .B(_245_),
    .Y(net98));
 sky130_fd_sc_hd__nand3_1 _688_ (.A(net656),
    .B(net659),
    .C(_229_),
    .Y(_246_));
 sky130_fd_sc_hd__xnor2_1 _689_ (.A(net204),
    .B(_246_),
    .Y(net134));
 sky130_fd_sc_hd__nand3_1 _690_ (.A(net656),
    .B(_148_),
    .C(_160_),
    .Y(_247_));
 sky130_fd_sc_hd__xnor2_1 _691_ (.A(net221),
    .B(_247_),
    .Y(net124));
 sky130_fd_sc_hd__nand3_1 _692_ (.A(net656),
    .B(_148_),
    .C(_198_),
    .Y(_248_));
 sky130_fd_sc_hd__xnor2_1 _693_ (.A(net224),
    .B(_248_),
    .Y(net122));
 sky130_fd_sc_hd__nand2_1 _694_ (.A(net660),
    .B(_224_),
    .Y(_249_));
 sky130_fd_sc_hd__xnor2_1 _695_ (.A(net248),
    .B(_249_),
    .Y(net109));
 sky130_fd_sc_hd__nand3_1 _696_ (.A(net656),
    .B(_181_),
    .C(_182_),
    .Y(_250_));
 sky130_fd_sc_hd__xnor2_1 _697_ (.A(net198),
    .B(_250_),
    .Y(net138));
 sky130_fd_sc_hd__nand3b_1 _698_ (.A_N(net656),
    .B(_126_),
    .C(_145_),
    .Y(_251_));
 sky130_fd_sc_hd__xnor2_1 _699_ (.A(net271),
    .B(_251_),
    .Y(net97));
 sky130_fd_sc_hd__nand3_1 _700_ (.A(net656),
    .B(_182_),
    .C(_198_),
    .Y(_252_));
 ...
 sky130_fd_sc_hd__xnor2_1 _739_ (.A(_279_),
    .B(_286_),
    .Y(_287_));
 sky130_fd_sc_hd__xnor2_1 _740_ (.A(net677),
    .B(_287_),
    .Y(_288_));
 sky130_fd_sc_hd__xnor2_1 _741_ (.A(net678),
    .B(_288_),
    .Y(\encoded_word[31] ));
 ...
 sky130_fd_sc_hd__xnor2_1 _748_ (.A(_291_),
    .B(_294_),
    .Y(_295_));
 sky130_fd_sc_hd__xnor2_1 _749_ (.A(net677),
    .B(_295_),
    .Y(_296_));
 ...
 sky130_fd_sc_hd__xnor2_1 _764_ (.A(_307_),
    .B(_309_),
    .Y(_310_));
 sky130_fd_sc_hd__xnor2_1 _765_ (.A(net683),
    .B(_310_),
    .Y(_311_));
 ...
 sky130_fd_sc_hd__xor2_1 _776_ (.A(net720),
    .B(net742),
    .X(_321_));
 sky130_fd_sc_hd__xnor2_1 _777_ (.A(net704),
    .B(net73),
    .Y(_322_));
 ...
 sky130_fd_sc_hd__xnor2_1 _809_ (.A(net709),
    .B(net717),
    .Y(_353_));
 sky130_fd_sc_hd__xnor2_1 _810_ (.A(net692),
    .B(net691),
    .Y(_354_));
 ...
 sky130_fd_sc_hd__xnor2_1 _826_ (.A(net734),
    .B(net744),
    .Y(_369_));
 sky130_fd_sc_hd__xnor2_1 _827_ (.A(net701),
    .B(net731),
    .Y(_370_));
 ...
 sky130_fd_sc_hd__xor2_2 _832_ (.A(_351_),
    .B(_374_),
    .X(\encoded_word[1] ));
 sky130_fd_sc_hd__nand3_1 _833_ (.A(net656),
    .B(_198_),
    .C(_229_),
    .Y(_375_));
 ...
 sky130_fd_sc_hd__xnor2_1 _836_ (.A(net281),
    .B(_376_),
    .Y(net154));
 sky130_fd_sc_hd__nand3_1 _837_ (.A(net656),
    .B(_160_),
    .C(_210_),
    .Y(_377_));
 sky130_fd_sc_hd__xnor2_1 _838_ (.A(net193),
    .B(_377_),
    .Y(net141));
 sky130_fd_sc_hd__nand3_1 _839_ (.A(net656),
    .B(net91),
    .C(_156_),
    .Y(_378_));
 ...
 sky130_fd_sc_hd__xnor2_1 _842_ (.A(net180),
    .B(_379_),
    .Y(net148));
 sky130_fd_sc_hd__nor4_2 _843_ (.A(net674),
    .B(_141_),
    .C(net673),
    .D(_208_),
    .Y(_380_));
 sky130_fd_sc_hd__nor2_1 _844_ (.A(net666),
    .B(_380_),
    .Y(net92));
 ...
 sky130_fd_sc_hd__xnor3_1 _851_ (.A(_296_),
    ...
    .C(_385_),
    .X(_386_));
 sky130_fd_sc_hd__xnor2_1 _852_ (.A(net669),
    .B(net668),
    .Y(_387_));
 sky130_fd_sc_hd__xnor2_1 _853_ (.A(_386_),
    .B(_387_),
    .Y(_388_));
 sky130_fd_sc_hd__xor2_1 _854_ (.A(net671),
    .B(net670),
    .X(_389_));
 sky130_fd_sc_hd__xnor2_2 _855_ (.A(_388_),
    .B(_389_),
    .Y(\encoded_word[71] ));
 sky130_fd_sc_hd__nand2_1 _856_ (.A(net662),
    .B(_160_),
    .Y(_390_));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold774 (.A(net777),
    .X(net773));
 sky130_fd_sc_hd__dlygate4sd3_1 hold775 (.A(net779),
    .X(net774));
 sky130_fd_sc_hd__dlygate4sd3_1 hold776 (.A(net289),
    .X(net775));
 sky130_fd_sc_hd__buf_16 hold777 (.A(net633),
    .X(net776));
 sky130_fd_sc_hd__dlygate4sd3_1 hold778 (.A(rstb),
    .X(net777));
 sky130_fd_sc_hd__dlygate4sd3_1 hold779 (.A(net773),
    .X(net778));
 sky130_fd_sc_hd__dlygate4sd3_1 hold780 (.A(net89),
    .X(net779));
 sky130_fd_sc_hd__dlygate4sd3_1 hold781 (.A(net774),
    .X(net780));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap168 (.A(net168),
    .X(net167));
 sky130_fd_sc_hd__clkbuf_2 max_cap169 (.A(net558),
    .X(net168));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap192 (.A(\data_dout[5] ),
    .X(net191));
 sky130_fd_sc_hd__clkbuf_1 max_cap193 (.A(net572),
    .X(net192));
 sky130_fd_sc_hd__clkbuf_2 max_cap194 (.A(net573),
    .X(net193));
 sky130_fd_sc_hd__clkbuf_2 max_cap195 (.A(net195),
    .X(net194));
 sky130_fd_sc_hd__clkbuf_2 max_cap196 (.A(net574),
    .X(net195));
 sky130_fd_sc_hd__clkbuf_1 max_cap197 (.A(net575),
    .X(net196));
 sky130_fd_sc_hd__clkbuf_2 max_cap198 (.A(net576),
    .X(net197));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap203 (.A(net203),
    .X(net202));
 sky130_fd_sc_hd__clkbuf_1 max_cap204 (.A(net579),
    .X(net203));
 sky130_fd_sc_hd__clkbuf_2 max_cap205 (.A(\data_dout[53] ),
    .X(net204));
 sky130_fd_sc_hd__clkbuf_2 max_cap206 (.A(\data_dout[52] ),
    .X(net205));
 sky130_fd_sc_hd__clkbuf_2 max_cap207 (.A(net582),
    .X(net206));
 sky130_fd_sc_hd__clkbuf_2 max_cap208 (.A(net208),
    .X(net207));
 sky130_fd_sc_hd__clkbuf_1 max_cap209 (.A(net583),
    .X(net208));
 sky130_fd_sc_hd__clkbuf_2 max_cap210 (.A(net210),
    .X(net209));
 sky130_fd_sc_hd__clkbuf_2 max_cap211 (.A(\data_dout[4] ),
    .X(net210));
 sky130_fd_sc_hd__clkbuf_2 max_cap212 (.A(net585),
    .X(net211));
 sky130_fd_sc_hd__clkbuf_1 max_cap213 (.A(net586),
    .X(net212));
 sky130_fd_sc_hd__clkbuf_2 max_cap214 (.A(net214),
    .X(net213));
 sky130_fd_sc_hd__clkbuf_2 max_cap215 (.A(net587),
    .X(net214));
 sky130_fd_sc_hd__clkbuf_2 max_cap216 (.A(net588),
    .X(net215));
 sky130_fd_sc_hd__clkbuf_1 max_cap217 (.A(net590),
    .X(net216));
 sky130_fd_sc_hd__clkbuf_2 max_cap218 (.A(\data_dout[46] ),
    .X(net217));
 sky130_fd_sc_hd__clkbuf_1 max_cap219 (.A(net592),
    .X(net218));
 sky130_fd_sc_hd__clkbuf_2 max_cap220 (.A(net591),
    .X(net219));
 sky130_fd_sc_hd__clkbuf_1 max_cap221 (.A(net593),
    .X(net220));
 sky130_fd_sc_hd__clkbuf_2 max_cap222 (.A(net594),
    .X(net221));
 sky130_fd_sc_hd__dlymetal6s2s_1 max_cap223 (.A(net596),
    .X(net222));
 sky130_fd_sc_hd__clkbuf_2 max_cap224 (.A(net595),
    .X(net223));
 sky130_fd_sc_hd__clkbuf_2 max_cap225 (.A(net225),
    .X(net224));
 sky130_fd_sc_hd__clkbuf_2 max_cap226 (.A(net597),
    .X(net225));
 sky130_fd_sc_hd__clkbuf_2 max_cap227 (.A(net227),
    .X(net226));
 sky130_fd_sc_hd__clkbuf_1 max_cap228 (.A(net598),
    .X(net227));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap229 (.A(net599),
    .X(net228));
 sky130_fd_sc_hd__clkbuf_2 max_cap230 (.A(\data_dout[40] ),
    .X(net229));
 sky130_fd_sc_hd__clkbuf_2 max_cap231 (.A(net601),
    .X(net230));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap235 (.A(\data_dout[37] ),
    .X(net234));
 sky130_fd_sc_hd__clkbuf_1 max_cap236 (.A(net605),
    .X(net235));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap243 (.A(net243),
    .X(net242));
 sky130_fd_sc_hd__clkbuf_1 max_cap244 (.A(net609),
    .X(net243));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap247 (.A(net247),
    .X(net246));
 sky130_fd_sc_hd__clkbuf_2 max_cap248 (.A(net611),
    .X(net247));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap257 (.A(net257),
    .X(net256));
 sky130_fd_sc_hd__clkbuf_2 max_cap258 (.A(net616),
    .X(net257));
 sky130_fd_sc_hd__clkbuf_1 max_cap259 (.A(\data_dout[24] ),
    .X(net258));
 sky130_fd_sc_hd__clkbuf_2 max_cap260 (.A(net617),
    .X(net259));
 sky130_fd_sc_hd__clkbuf_2 max_cap261 (.A(net261),
    .X(net260));
 sky130_fd_sc_hd__clkbuf_1 max_cap262 (.A(net619),
    .X(net261));
 sky130_fd_sc_hd__clkbuf_2 max_cap263 (.A(net263),
    .X(net262));
 sky130_fd_sc_hd__clkbuf_1 max_cap264 (.A(net620),
    .X(net263));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap270 (.A(net270),
    .X(net269));
 sky130_fd_sc_hd__clkbuf_2 max_cap271 (.A(net624),
    .X(net270));
 sky130_fd_sc_hd__clkbuf_2 max_cap272 (.A(net272),
    .X(net271));
 sky130_fd_sc_hd__clkbuf_2 max_cap273 (.A(net625),
    .X(net272));
 sky130_fd_sc_hd__clkbuf_2 max_cap274 (.A(net626),
    .X(net273));
 sky130_fd_sc_hd__clkbuf_2 max_cap275 (.A(net275),
    .X(net274));
 sky130_fd_sc_hd__clkbuf_1 max_cap276 (.A(net627),
    .X(net275));
 sky130_fd_sc_hd__clkbuf_2 max_cap277 (.A(net628),
    .X(net276));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap282 (.A(net282),
    .X(net281));
 sky130_fd_sc_hd__clkbuf_2 max_cap283 (.A(net631),
    .X(net282));
 sky130_fd_sc_hd__clkbuf_2 max_cap284 (.A(net284),
    .X(net283));
 sky130_fd_sc_hd__clkbuf_2 max_cap285 (.A(\data_dout[10] ),
    .X(net284));
 sky130_fd_sc_hd__clkbuf_1 max_cap559 (.A(\ecc_dout[6] ),
    .X(net558));
 sky130_fd_sc_hd__clkbuf_1 max_cap560 (.A(\ecc_dout[5] ),
    .X(net559));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap561 (.A(\ecc_dout[4] ),
    .X(net560));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap562 (.A(\ecc_dout[3] ),
    .X(net561));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap563 (.A(\ecc_dout[2] ),
    .X(net562));
 sky130_fd_sc_hd__clkbuf_1 max_cap564 (.A(\ecc_dout[1] ),
    .X(net563));
 sky130_fd_sc_hd__clkbuf_2 max_cap565 (.A(\ecc_dout[0] ),
    .X(net564));
 sky130_fd_sc_hd__clkbuf_1 max_cap566 (.A(\data_dout[9] ),
    .X(net565));
 sky130_fd_sc_hd__clkbuf_2 max_cap567 (.A(\data_dout[8] ),
    .X(net566));
 sky130_fd_sc_hd__clkbuf_1 max_cap568 (.A(\data_dout[6] ),
    .X(net567));
 sky130_fd_sc_hd__clkbuf_1 max_cap569 (.A(\data_dout[62] ),
    .X(net568));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap570 (.A(\data_dout[61] ),
    .X(net569));
 sky130_fd_sc_hd__clkbuf_1 max_cap571 (.A(\data_dout[60] ),
    .X(net570));
 sky130_fd_sc_hd__clkbuf_1 max_cap572 (.A(\data_dout[5] ),
    .X(net571));
 sky130_fd_sc_hd__clkbuf_2 max_cap573 (.A(net573),
    .X(net572));
 sky130_fd_sc_hd__clkbuf_2 max_cap574 (.A(\data_dout[59] ),
    .X(net573));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap575 (.A(\data_dout[58] ),
    .X(net574));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap576 (.A(net576),
    .X(net575));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap577 (.A(\data_dout[57] ),
    .X(net576));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap578 (.A(\data_dout[56] ),
    .X(net577));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap579 (.A(\data_dout[55] ),
    .X(net578));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap580 (.A(\data_dout[54] ),
    .X(net579));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap581 (.A(\data_dout[53] ),
    .X(net580));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap582 (.A(\data_dout[52] ),
    .X(net581));
 sky130_fd_sc_hd__clkbuf_2 max_cap583 (.A(\data_dout[51] ),
    .X(net582));
 sky130_fd_sc_hd__clkbuf_1 max_cap584 (.A(\data_dout[50] ),
    .X(net583));
 sky130_fd_sc_hd__clkbuf_1 max_cap585 (.A(\data_dout[4] ),
    .X(net584));
 sky130_fd_sc_hd__clkbuf_2 max_cap586 (.A(net586),
    .X(net585));
 sky130_fd_sc_hd__clkbuf_2 max_cap587 (.A(\data_dout[49] ),
    .X(net586));
 sky130_fd_sc_hd__clkbuf_1 max_cap588 (.A(\data_dout[48] ),
    .X(net587));
 sky130_fd_sc_hd__clkbuf_1 max_cap589 (.A(\data_dout[47] ),
    .X(net588));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap590 (.A(net590),
    .X(net589));
 sky130_fd_sc_hd__dlymetal6s2s_1 max_cap591 (.A(\data_dout[46] ),
    .X(net590));
 sky130_fd_sc_hd__clkbuf_1 max_cap592 (.A(net592),
    .X(net591));
 sky130_fd_sc_hd__clkbuf_2 max_cap593 (.A(\data_dout[45] ),
    .X(net592));
 sky130_fd_sc_hd__clkbuf_1 max_cap594 (.A(net594),
    .X(net593));
 sky130_fd_sc_hd__clkbuf_2 max_cap595 (.A(\data_dout[44] ),
    .X(net594));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap596 (.A(net596),
    .X(net595));
 sky130_fd_sc_hd__clkbuf_1 max_cap597 (.A(\data_dout[43] ),
    .X(net596));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap598 (.A(\data_dout[42] ),
    .X(net597));
 sky130_fd_sc_hd__clkbuf_1 max_cap599 (.A(\data_dout[41] ),
    .X(net598));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap600 (.A(net600),
    .X(net599));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap601 (.A(\data_dout[40] ),
    .X(net600));
 sky130_fd_sc_hd__clkbuf_1 max_cap602 (.A(\data_dout[39] ),
    .X(net601));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap603 (.A(\data_dout[38] ),
    .X(net602));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap604 (.A(\data_dout[37] ),
    .X(net603));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap605 (.A(net605),
    .X(net604));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap606 (.A(\data_dout[36] ),
    .X(net605));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap607 (.A(\data_dout[35] ),
    .X(net606));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap608 (.A(\data_dout[34] ),
    .X(net607));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap609 (.A(\data_dout[33] ),
    .X(net608));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap610 (.A(\data_dout[32] ),
    .X(net609));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap611 (.A(\data_dout[30] ),
    .X(net610));
 sky130_fd_sc_hd__clkbuf_1 max_cap612 (.A(\data_dout[2] ),
    .X(net611));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap613 (.A(\data_dout[29] ),
    .X(net612));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap614 (.A(\data_dout[28] ),
    .X(net613));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap615 (.A(\data_dout[27] ),
    .X(net614));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap616 (.A(\data_dout[26] ),
    .X(net615));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap617 (.A(\data_dout[25] ),
    .X(net616));
 sky130_fd_sc_hd__clkbuf_1 max_cap618 (.A(net618),
    .X(net617));
 sky130_fd_sc_hd__clkbuf_2 max_cap619 (.A(\data_dout[24] ),
    .X(net618));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap620 (.A(\data_dout[23] ),
    .X(net619));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap621 (.A(\data_dout[22] ),
    .X(net620));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap622 (.A(\data_dout[21] ),
    .X(net621));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap623 (.A(\data_dout[20] ),
    .X(net622));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap624 (.A(\data_dout[1] ),
    .X(net623));
 sky130_fd_sc_hd__clkbuf_1 max_cap625 (.A(\data_dout[19] ),
    .X(net624));
 sky130_fd_sc_hd__clkbuf_2 max_cap626 (.A(\data_dout[18] ),
    .X(net625));
 sky130_fd_sc_hd__clkbuf_1 max_cap627 (.A(\data_dout[17] ),
    .X(net626));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap628 (.A(\data_dout[16] ),
    .X(net627));
 sky130_fd_sc_hd__clkbuf_1 max_cap629 (.A(\data_dout[14] ),
    .X(net628));
 sky130_fd_sc_hd__clkbuf_1 max_cap630 (.A(\data_dout[13] ),
    .X(net629));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap631 (.A(\data_dout[12] ),
    .X(net630));
 sky130_fd_sc_hd__clkbuf_2 max_cap632 (.A(\data_dout[11] ),
    .X(net631));
 sky130_fd_sc_hd__clkdlybuf4s50_1 max_cap633 (.A(\data_dout[10] ),
    .X(net632));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output117 (.A(net653),
    .X(payload_out[30]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output136 (.A(net652),
    .X(payload_out[48]));
 ...
 sky130_fd_sc_hd__buf_4 place461 (.A(net107),
    .X(payload_out[22]));
 sky130_fd_sc_hd__buf_4 place636 (.A(net147),
    .X(payload_out[59]));
 sky130_fd_sc_hd__buf_4 place637 (.A(net126),
    .X(payload_out[3]));
 ...
 sky130_fd_sc_hd__buf_4 place643 (.A(net149),
    .X(payload_out[60]));
 sky130_fd_sc_hd__buf_4 place644 (.A(net146),
    .X(payload_out[58]));
 ...
 sky130_fd_sc_hd__buf_4 place647 (.A(net115),
    .X(payload_out[2]));
 sky130_fd_sc_hd__buf_4 place648 (.A(net113),
    .X(payload_out[28]));
 sky130_fd_sc_hd__buf_4 place649 (.A(net112),
    .X(payload_out[27]));
 sky130_fd_sc_hd__buf_4 place650 (.A(net110),
    .X(payload_out[25]));
 sky130_fd_sc_hd__buf_4 place651 (.A(net109),
    .X(payload_out[24]));
 sky130_fd_sc_hd__buf_4 place652 (.A(net106),
    .X(payload_out[21]));
 sky130_fd_sc_hd__buf_4 place653 (.A(net135),
    .X(net652));
 sky130_fd_sc_hd__buf_4 place654 (.A(net116),
    .X(net653));
 ...
 sky130_fd_sc_hd__buf_4 place657 (.A(_100_),
    .X(net656));
 sky130_fd_sc_hd__buf_4 place658 (.A(net91),
    .X(correction_applied));
 sky130_fd_sc_hd__buf_4 place659 (.A(_203_),
    .X(net658));
 sky130_fd_sc_hd__buf_4 place660 (.A(_188_),
    .X(net659));
 sky130_fd_sc_hd__buf_4 place661 (.A(_174_),
    .X(net660));
 sky130_fd_sc_hd__buf_4 place662 (.A(_163_),
    .X(net661));
 sky130_fd_sc_hd__buf_4 place663 (.A(_155_),
    .X(net662));
 sky130_fd_sc_hd__buf_4 place664 (.A(_099_),
    .X(net663));
 sky130_fd_sc_hd__buf_4 place665 (.A(_192_),
    .X(net664));
 sky130_fd_sc_hd__buf_4 place666 (.A(_168_),
    .X(net665));
 sky130_fd_sc_hd__buf_4 place667 (.A(_124_),
    .X(net666));
 sky130_fd_sc_hd__buf_4 place668 (.A(\encoded_word[1] ),
    .X(net667));
 sky130_fd_sc_hd__buf_4 place669 (.A(\encoded_word[0] ),
    .X(net668));
 sky130_fd_sc_hd__buf_4 place670 (.A(\encoded_word[3] ),
    .X(net669));
 sky130_fd_sc_hd__buf_4 place671 (.A(\encoded_word[7] ),
    .X(net670));
 sky130_fd_sc_hd__buf_4 place672 (.A(\encoded_word[15] ),
    .X(net671));
 sky130_fd_sc_hd__buf_4 place673 (.A(_143_),
    .X(net672));
 sky130_fd_sc_hd__buf_4 place674 (.A(_139_),
    .X(net673));
 sky130_fd_sc_hd__buf_4 place675 (.A(_097_),
    .X(net674));
 sky130_fd_sc_hd__buf_4 place676 (.A(_084_),
    .X(net675));
 sky130_fd_sc_hd__buf_4 place677 (.A(_016_),
    .X(net676));
 sky130_fd_sc_hd__buf_4 place678 (.A(_274_),
    .X(net677));
 sky130_fd_sc_hd__buf_4 place679 (.A(_266_),
    .X(net678));
 sky130_fd_sc_hd__buf_4 place680 (.A(_110_),
    .X(net679));
 sky130_fd_sc_hd__buf_4 place681 (.A(_077_),
    .X(net680));
 sky130_fd_sc_hd__buf_4 place682 (.A(_044_),
    .X(net681));
 sky130_fd_sc_hd__buf_4 place683 (.A(_024_),
    .X(net682));
 sky130_fd_sc_hd__buf_4 place684 (.A(_273_),
    .X(net683));
 sky130_fd_sc_hd__buf_4 place685 (.A(\encoded_word[63] ),
    .X(net684));
 sky130_fd_sc_hd__buf_4 place686 (.A(_117_),
    .X(net685));
 sky130_fd_sc_hd__buf_4 place687 (.A(_116_),
    .X(net686));
 sky130_fd_sc_hd__buf_4 place688 (.A(_087_),
    .X(net687));
 sky130_fd_sc_hd__buf_4 place689 (.A(_063_),
    .X(net688));
 sky130_fd_sc_hd__buf_4 place690 (.A(_062_),
    .X(net689));
 sky130_fd_sc_hd__buf_4 place691 (.A(_018_),
    .X(net690));
 sky130_fd_sc_hd__buf_4 place692 (.A(_353_),
    .X(net691));
 sky130_fd_sc_hd__buf_4 place693 (.A(_352_),
    .X(net692));
 sky130_fd_sc_hd__buf_4 place694 (.A(_334_),
    .X(net693));
 ...
 sky130_fd_sc_hd__buf_16 wire290 (.A(net780),
    .X(net289));
 sky130_fd_sc_hd__buf_16 wire634 (.A(net775),
    .X(net633));
 sky130_fd_sc_hd__buf_16 wire635 (.A(net288),
    .X(net634));
endmodule
