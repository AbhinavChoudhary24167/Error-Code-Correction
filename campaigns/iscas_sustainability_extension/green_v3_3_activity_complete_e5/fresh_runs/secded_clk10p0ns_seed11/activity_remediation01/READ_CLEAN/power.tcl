...
source /campaign-run/power_explicit_activity/remediation01/READ_CLEAN/routed_net_activity.tcl
report_activity_annotation > /campaign-run/power_explicit_activity/remediation01/READ_CLEAN/annotation.rpt
report_activity_annotation -report_annotated > /campaign-run/power_explicit_activity/remediation01/READ_CLEAN/annotated.rpt
report_activity_annotation -report_unannotated > /campaign-run/power_explicit_activity/remediation01/READ_CLEAN/unannotated.rpt
report_power -digits 12 > /campaign-run/power_explicit_activity/remediation01/READ_CLEAN/power.rpt
report_power -format json > /campaign-run/power_explicit_activity/remediation01/READ_CLEAN/power.json
report_power -instances [get_cells {u_data u_ecc0}] -digits 12 > /campaign-run/power_explicit_activity/remediation01/READ_CLEAN/macros.power.rpt
puts "GREEN_V33_POWER_COMPLETE architecture=secded_matched_sram_top operation=READ_CLEAN"
