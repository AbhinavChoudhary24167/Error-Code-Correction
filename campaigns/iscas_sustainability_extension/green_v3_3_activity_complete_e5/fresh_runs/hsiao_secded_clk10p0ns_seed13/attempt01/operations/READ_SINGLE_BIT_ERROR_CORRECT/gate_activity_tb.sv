...
module tb;
  ...
  initial begin
    failures = 0;
    $readmemh("/mnt/c/Users/Abhinav/OneDrive/Desktop/ECC/Error-Code-Correction/campaigns/iscas_sustainability_extension/green_v3_3_activity_complete_e5/fresh_runs/hsiao_secded_clk10p0ns_seed13/attempt01/workloads/payloads.hex", payloads);
    $readmemh("/mnt/c/Users/Abhinav/OneDrive/Desktop/ECC/Error-Code-Correction/campaigns/iscas_sustainability_extension/green_v3_3_activity_complete_e5/fresh_runs/hsiao_secded_clk10p0ns_seed13/attempt01/workloads/codewords_read_single_bit_error_correct.hex", codewords);
    ...
    $dumpfile("/var/lib/green-ecc-v33-activity-complete-e5/fresh_runs/hsiao_secded_clk10p0ns_seed13/attempt01/activity/READ_SINGLE_BIT_ERROR_CORRECT.vcd");
    $dumpvars(1, dut);
