# SKY130HD default PDN with additive, case-correct connections for the
# published SRAM22 macro supplies. The upstream macro LEF/GDS are untouched.
...
add_pdn_connect -grid {CORE_macro_grid_1} -layers {met2 met4}
...
add_pdn_connect -grid {CORE_macro_grid_2} -layers {met2 met4}
