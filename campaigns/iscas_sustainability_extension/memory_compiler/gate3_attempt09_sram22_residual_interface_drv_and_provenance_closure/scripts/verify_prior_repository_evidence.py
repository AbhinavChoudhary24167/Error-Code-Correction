#!/usr/bin/env python3
"""Freshly rehash repository-resident evidence from Attempts01--08."""
...
specs = [
    ...
    ("Attempt08 repository evidence", MEMORY / "gate3_attempt08_sram22_slew_provenance_and_drv_closure" / "ATTEMPT08_EVIDENCE_MANIFEST.json", MEMORY / "gate3_attempt08_sram22_slew_provenance_and_drv_closure", "files"),
]
campaigns = [verify(*spec) for spec in specs]
payload = {
    "schema_version": 1, "algorithm": "sha256",
    "scope": "repository-resident files listed by preserved Attempts01--08 manifests",
