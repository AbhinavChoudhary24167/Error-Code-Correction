...

{
  ...
  # Preserve the matched Attempt07/08 carry-forward rule. No Liberty or SDC
  # exception is introduced; constrained final STA remains authoritative.
