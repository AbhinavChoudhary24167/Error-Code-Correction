module e0_sram22_top (ce,
 ...
 sky130_fd_sc_hd__inv_16 attempt09_ecc_rstb_stage1 (.A(net637),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold822 (.A(net302),
    .X(net821));
 sky130_fd_sc_hd__dlygate4sd3_1 hold823 (.A(payload_in[56]),
    .X(net822));
 sky130_fd_sc_hd__dlygate4sd3_1 hold824 (.A(payload_in[57]),
    .X(net823));
 sky130_fd_sc_hd__dlygate4sd3_1 hold825 (.A(payload_in[52]),
    .X(net824));
 sky130_fd_sc_hd__dlygate4sd3_1 hold826 (.A(payload_in[61]),
    .X(net825));
 sky130_fd_sc_hd__dlygate4sd3_1 hold827 (.A(payload_in[54]),
    .X(net826));
 sky130_fd_sc_hd__dlygate4sd3_1 hold828 (.A(payload_in[3]),
    .X(net827));
 sky130_fd_sc_hd__dlygate4sd3_1 hold829 (.A(payload_in[14]),
    .X(net828));
 sky130_fd_sc_hd__dlygate4sd3_1 hold830 (.A(payload_in[49]),
    .X(net829));
 sky130_fd_sc_hd__dlygate4sd3_1 hold831 (.A(payload_in[17]),
    .X(net830));
 sky130_fd_sc_hd__dlygate4sd3_1 hold832 (.A(payload_in[59]),
    .X(net831));
 sky130_fd_sc_hd__dlygate4sd3_1 hold833 (.A(payload_in[4]),
    .X(net832));
 ...
 sky130_fd_sc_hd__buf_2 input30 (.A(payload_in[13]),
    .X(net29));
 sky130_fd_sc_hd__buf_2 input31 (.A(net828),
    .X(net30));
 ...
 sky130_fd_sc_hd__buf_2 input58 (.A(payload_in[39]),
    .X(net57));
 sky130_fd_sc_hd__buf_2 input59 (.A(net827),
    .X(net58));
 ...
 sky130_fd_sc_hd__buf_4 place747 (.A(net747),
    .X(net746));
 sky130_fd_sc_hd__buf_8 place748 (.A(net77),
    .X(net747));
 sky130_fd_sc_hd__buf_4 place749 (.A(net749),
    .X(net748));
 sky130_fd_sc_hd__buf_8 place750 (.A(net76),
    .X(net749));
